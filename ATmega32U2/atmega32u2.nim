# Peripheral access API for ATMEGA32U2 microcontrollers (generated using svd2nim)
...
proc write*(reg: FUSE_HIGH_Type, BOOTRST: bool = false, BOOTSZ: FUSE_HIGH_BOOTSZ = x2048W_3800, EESAVE: bool = false, WDTON: bool = false, SPIEN: bool = false, RSTDISBL: bool = false, DWEN: bool = false) =
  var x: uint8
