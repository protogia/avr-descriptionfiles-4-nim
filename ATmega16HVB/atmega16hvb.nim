# Peripheral access API for ATMEGA16HVB microcontrollers (generated using svd2nim)
...
proc write*(reg: FUSE_HIGH_Type, BOOTRST: bool = false, BOOTSZ: FUSE_HIGH_BOOTSZ = x2048W_1800, DWEN: bool = false, CKDIV8: bool = false) =
  var x: uint8
