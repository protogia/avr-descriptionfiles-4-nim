# Peripheral access API for ATMEGA164A microcontrollers (generated using svd2nim)
...
proc write*(reg: SPI_SPCR0_Type, SPR00: SPI_SPCR0_SPR00 = FOSC_4, SPR01: bool = false, CPHA0: bool = false, CPOL0: bool = false, MSTR0: bool = false, DORD0: bool = false, SPE0: bool = false, SPIE0: bool = false) =
  var x: uint8
  x.setMask((SPR00.uint8 shl 0).masked(0 .. 0))
  x.setMask((SPR01.uint8 shl 1).masked(1 .. 1))
...
func SPR01*(r: SPI_SPCR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SPR01=`*(r: var SPI_SPCR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.SPI_SPCR0_Fields
