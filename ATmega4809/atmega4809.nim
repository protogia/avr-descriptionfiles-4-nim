# Peripheral access API for ATMEGA4809 microcontrollers (generated using svd2nim)
...
# #### Device Peripheral Interrupts ############################################
  ...
  irqTCB3_INT          =   36 # No Description.
  irqUSART3_RXC        =   37 # No Description.
  irqUSART3_DRE        =   38 # No Description.
  irqUSART3_TXC        =   39 # No Description.
...
type EVSYS_CHANNEL6_Type* = object
  loc: uint

type EVSYS_CHANNEL7_Type* = object
  loc: uint
...
type EVSYS_Type* = object
  ...
  CHANNEL6*: EVSYS_CHANNEL6_Type
  CHANNEL7*: EVSYS_CHANNEL7_Type
...
type TCB3_CCMP_Type* = object
  loc: uint

type TCB3_CNT_Type* = object
  loc: uint

type TCB3_CTRLA_Type* = object
  loc: uint

type TCB3_CTRLB_Type* = object
  loc: uint

type TCB3_DBGCTRL_Type* = object
  loc: uint

type TCB3_EVCTRL_Type* = object
  loc: uint

type TCB3_INTCTRL_Type* = object
  loc: uint

type TCB3_INTFLAGS_Type* = object
  loc: uint

type TCB3_STATUS_Type* = object
  loc: uint

type TCB3_TEMP_Type* = object
  loc: uint

type TCB3_Type* = object
  CTRLA*: TCB3_CTRLA_Type
  CTRLB*: TCB3_CTRLB_Type
  EVCTRL*: TCB3_EVCTRL_Type
  INTCTRL*: TCB3_INTCTRL_Type
  INTFLAGS*: TCB3_INTFLAGS_Type
  STATUS*: TCB3_STATUS_Type
  DBGCTRL*: TCB3_DBGCTRL_Type
  TEMP*: TCB3_TEMP_Type
  CNT*: TCB3_CNT_Type
  CCMP*: TCB3_CCMP_Type
...
type USART3_BAUD_Type* = object
  loc: uint

type USART3_CTRLA_Type* = object
  loc: uint

type USART3_CTRLB_Type* = object
  loc: uint

type USART3_CTRLC_Type* = object
  loc: uint

type USART3_CTRLD_Type* = object
  loc: uint

type USART3_DBGCTRL_Type* = object
  loc: uint

type USART3_EVCTRL_Type* = object
  loc: uint

type USART3_RXDATAH_Type* = object
  loc: uint

type USART3_RXDATAL_Type* = object
  loc: uint

type USART3_RXPLCTRL_Type* = object
  loc: uint

type USART3_STATUS_Type* = object
  loc: uint

type USART3_TXDATAH_Type* = object
  loc: uint

type USART3_TXDATAL_Type* = object
  loc: uint

type USART3_TXPLCTRL_Type* = object
  loc: uint

type USART3_Type* = object
  RXDATAL*: USART3_RXDATAL_Type
  RXDATAH*: USART3_RXDATAH_Type
  TXDATAL*: USART3_TXDATAL_Type
  TXDATAH*: USART3_TXDATAH_Type
  STATUS*: USART3_STATUS_Type
  CTRLA*: USART3_CTRLA_Type
  CTRLB*: USART3_CTRLB_Type
  CTRLC*: USART3_CTRLC_Type
  BAUD*: USART3_BAUD_Type
  CTRLD*: USART3_CTRLD_Type
  DBGCTRL*: USART3_DBGCTRL_Type
  EVCTRL*: USART3_EVCTRL_Type
  TXPLCTRL*: USART3_TXPLCTRL_Type
  RXPLCTRL*: USART3_RXPLCTRL_Type
...
const EVSYS* = EVSYS_Type(
  ...
  CHANNEL6: EVSYS_CHANNEL6_Type(loc: 0x196'u),
  CHANNEL7: EVSYS_CHANNEL7_Type(loc: 0x197'u),
...
const TCB3* = TCB3_Type(
  CTRLA: TCB3_CTRLA_Type(loc: 0xab0'u),
  CTRLB: TCB3_CTRLB_Type(loc: 0xab1'u),
  EVCTRL: TCB3_EVCTRL_Type(loc: 0xab4'u),
  INTCTRL: TCB3_INTCTRL_Type(loc: 0xab5'u),
  INTFLAGS: TCB3_INTFLAGS_Type(loc: 0xab6'u),
  STATUS: TCB3_STATUS_Type(loc: 0xab7'u),
  DBGCTRL: TCB3_DBGCTRL_Type(loc: 0xab8'u),
  TEMP: TCB3_TEMP_Type(loc: 0xab9'u),
  CNT: TCB3_CNT_Type(loc: 0xaba'u),
  CCMP: TCB3_CCMP_Type(loc: 0xabc'u),
)
...
const USART3* = USART3_Type(
  RXDATAL: USART3_RXDATAL_Type(loc: 0x860'u),
  RXDATAH: USART3_RXDATAH_Type(loc: 0x861'u),
  TXDATAL: USART3_TXDATAL_Type(loc: 0x862'u),
  TXDATAH: USART3_TXDATAH_Type(loc: 0x863'u),
  STATUS: USART3_STATUS_Type(loc: 0x864'u),
  CTRLA: USART3_CTRLA_Type(loc: 0x865'u),
  CTRLB: USART3_CTRLB_Type(loc: 0x866'u),
  CTRLC: USART3_CTRLC_Type(loc: 0x867'u),
  BAUD: USART3_BAUD_Type(loc: 0x868'u),
  CTRLD: USART3_CTRLD_Type(loc: 0x86a'u),
  DBGCTRL: USART3_DBGCTRL_Type(loc: 0x86b'u),
  EVCTRL: USART3_EVCTRL_Type(loc: 0x86c'u),
  TXPLCTRL: USART3_TXPLCTRL_Type(loc: 0x86d'u),
  RXPLCTRL: USART3_RXPLCTRL_Type(loc: 0x86e'u),
)
...
type EVSYS_CHANNEL6_GENERATOR* {.size: 1.} = enum
  OFF = 0x0,
  UPDI = 0x1,
  RTC_OVF = 0x6,
  RTC_CMP = 0x7,
...
type EVSYS_CHANNEL7_GENERATOR* {.size: 1.} = enum
  OFF = 0x0,
  UPDI = 0x1,
  RTC_OVF = 0x6,
  RTC_CMP = 0x7,
...
proc read*(reg: EVSYS_CHANNEL6_Type): EVSYS_CHANNEL6_GENERATOR {.inline.} =
  volatileLoad(cast[ptr EVSYS_CHANNEL6_GENERATOR](reg.loc))

proc write*(reg: EVSYS_CHANNEL6_Type, val: EVSYS_CHANNEL6_GENERATOR) {.inline.} =
  volatileStore(cast[ptr EVSYS_CHANNEL6_GENERATOR](reg.loc), val)

template modifyIt*(reg: EVSYS_CHANNEL6_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: EVSYS_CHANNEL7_Type): EVSYS_CHANNEL7_GENERATOR {.inline.} =
  volatileLoad(cast[ptr EVSYS_CHANNEL7_GENERATOR](reg.loc))

proc write*(reg: EVSYS_CHANNEL7_Type, val: EVSYS_CHANNEL7_GENERATOR) {.inline.} =
  volatileStore(cast[ptr EVSYS_CHANNEL7_GENERATOR](reg.loc), val)

template modifyIt*(reg: EVSYS_CHANNEL7_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)
...
type
  PORTB_DIR_Fields* = distinct uint8
  PORTB_DIRCLR_Fields* = distinct uint8
  PORTB_DIRSET_Fields* = distinct uint8
  PORTB_DIRTGL_Fields* = distinct uint8
  PORTB_IN_Fields* = distinct uint8
  PORTB_INTFLAGS_Fields* = distinct uint8
  PORTB_OUT_Fields* = distinct uint8
  PORTB_OUTCLR_Fields* = distinct uint8
  PORTB_OUTSET_Fields* = distinct uint8
  PORTB_OUTTGL_Fields* = distinct uint8
...
proc read*(reg: PORTB_DIR_Type): PORTB_DIR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_DIR_Fields](reg.loc))

proc write*(reg: PORTB_DIR_Type, val: PORTB_DIR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_DIR_Fields](reg.loc), val)

proc write*(reg: PORTB_DIR_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
...
proc read*(reg: PORTB_DIRCLR_Type): PORTB_DIRCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_DIRCLR_Fields](reg.loc))

proc write*(reg: PORTB_DIRCLR_Type, val: PORTB_DIRCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_DIRCLR_Fields](reg.loc), val)

proc write*(reg: PORTB_DIRCLR_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_DIRCLR_Fields
...
proc read*(reg: PORTB_DIRSET_Type): PORTB_DIRSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_DIRSET_Fields](reg.loc))

proc write*(reg: PORTB_DIRSET_Type, val: PORTB_DIRSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_DIRSET_Fields](reg.loc), val)

proc write*(reg: PORTB_DIRSET_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_DIRSET_Fields
...
proc read*(reg: PORTB_DIRTGL_Type): PORTB_DIRTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_DIRTGL_Fields](reg.loc))

proc write*(reg: PORTB_DIRTGL_Type, val: PORTB_DIRTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_DIRTGL_Fields](reg.loc), val)

proc write*(reg: PORTB_DIRTGL_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_DIRTGL_Fields
...
proc read*(reg: PORTB_IN_Type): PORTB_IN_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_IN_Fields](reg.loc))

proc write*(reg: PORTB_IN_Type, val: PORTB_IN_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_IN_Fields](reg.loc), val)

proc write*(reg: PORTB_IN_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTB_INTFLAGS_Type): PORTB_INTFLAGS_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_INTFLAGS_Fields](reg.loc))

proc write*(reg: PORTB_INTFLAGS_Type, val: PORTB_INTFLAGS_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_INTFLAGS_Fields](reg.loc), val)

proc write*(reg: PORTB_INTFLAGS_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_INTFLAGS_Fields
...
proc read*(reg: PORTB_OUT_Type): PORTB_OUT_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_OUT_Fields](reg.loc))

proc write*(reg: PORTB_OUT_Type, val: PORTB_OUT_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_OUT_Fields](reg.loc), val)

proc write*(reg: PORTB_OUT_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTB_OUTCLR_Type): PORTB_OUTCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_OUTCLR_Fields](reg.loc))

proc write*(reg: PORTB_OUTCLR_Type, val: PORTB_OUTCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_OUTCLR_Fields](reg.loc), val)

proc write*(reg: PORTB_OUTCLR_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_OUTCLR_Fields
...
proc read*(reg: PORTB_OUTSET_Type): PORTB_OUTSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_OUTSET_Fields](reg.loc))

proc write*(reg: PORTB_OUTSET_Type, val: PORTB_OUTSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_OUTSET_Fields](reg.loc), val)

proc write*(reg: PORTB_OUTSET_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_OUTSET_Fields
...
proc read*(reg: PORTB_OUTTGL_Type): PORTB_OUTTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTB_OUTTGL_Fields](reg.loc))

proc write*(reg: PORTB_OUTTGL_Type, val: PORTB_OUTTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTB_OUTTGL_Fields](reg.loc), val)

proc write*(reg: PORTB_OUTTGL_Type, PB0: bool = false, PB1: bool = false, PB2: bool = false, PB3: bool = false, PB4: bool = false, PB5: bool = false) =
  var x: uint8
  x.setMask((PB0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PB1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PB2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PB4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PB5.uint8 shl 5).masked(5 .. 5))
  reg.write x.PORTB_OUTTGL_Fields
...
func PB0*(r: PORTB_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_DIR_Fields

func PB1*(r: PORTB_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_DIR_Fields

func PB2*(r: PORTB_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_DIR_Fields

func PB3*(r: PORTB_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_DIR_Fields

func PB4*(r: PORTB_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_DIR_Fields

func PB5*(r: PORTB_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_DIR_Fields

func PB0*(r: PORTB_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_DIRCLR_Fields

func PB1*(r: PORTB_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_DIRCLR_Fields

func PB2*(r: PORTB_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_DIRCLR_Fields

func PB3*(r: PORTB_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_DIRCLR_Fields

func PB4*(r: PORTB_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_DIRCLR_Fields

func PB5*(r: PORTB_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_DIRCLR_Fields

func PB0*(r: PORTB_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_DIRSET_Fields

func PB1*(r: PORTB_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_DIRSET_Fields

func PB2*(r: PORTB_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_DIRSET_Fields

func PB3*(r: PORTB_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_DIRSET_Fields

func PB4*(r: PORTB_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_DIRSET_Fields

func PB5*(r: PORTB_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_DIRSET_Fields

func PB0*(r: PORTB_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_DIRTGL_Fields

func PB1*(r: PORTB_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_DIRTGL_Fields

func PB2*(r: PORTB_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_DIRTGL_Fields

func PB3*(r: PORTB_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_DIRTGL_Fields

func PB4*(r: PORTB_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_DIRTGL_Fields

func PB5*(r: PORTB_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_DIRTGL_Fields

func PB0*(r: PORTB_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_IN_Fields

func PB1*(r: PORTB_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_IN_Fields

func PB2*(r: PORTB_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_IN_Fields

func PB3*(r: PORTB_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_IN_Fields

func PB4*(r: PORTB_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_IN_Fields

func PB5*(r: PORTB_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_IN_Fields

func PB0*(r: PORTB_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_INTFLAGS_Fields

func PB1*(r: PORTB_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_INTFLAGS_Fields

func PB2*(r: PORTB_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_INTFLAGS_Fields

func PB3*(r: PORTB_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_INTFLAGS_Fields

func PB4*(r: PORTB_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_INTFLAGS_Fields

func PB5*(r: PORTB_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_INTFLAGS_Fields

func PB0*(r: PORTB_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_OUT_Fields

func PB1*(r: PORTB_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_OUT_Fields

func PB2*(r: PORTB_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_OUT_Fields

func PB3*(r: PORTB_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_OUT_Fields

func PB4*(r: PORTB_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_OUT_Fields

func PB5*(r: PORTB_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_OUT_Fields

func PB0*(r: PORTB_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_OUTCLR_Fields

func PB1*(r: PORTB_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_OUTCLR_Fields

func PB2*(r: PORTB_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_OUTCLR_Fields

func PB3*(r: PORTB_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_OUTCLR_Fields

func PB4*(r: PORTB_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_OUTCLR_Fields

func PB5*(r: PORTB_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_OUTCLR_Fields

func PB0*(r: PORTB_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_OUTSET_Fields

func PB1*(r: PORTB_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_OUTSET_Fields

func PB2*(r: PORTB_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_OUTSET_Fields

func PB3*(r: PORTB_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_OUTSET_Fields

func PB4*(r: PORTB_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_OUTSET_Fields

func PB5*(r: PORTB_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_OUTSET_Fields

func PB0*(r: PORTB_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PB0=`*(r: var PORTB_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTB_OUTTGL_Fields

func PB1*(r: PORTB_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PB1=`*(r: var PORTB_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTB_OUTTGL_Fields

func PB2*(r: PORTB_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PB2=`*(r: var PORTB_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTB_OUTTGL_Fields

func PB3*(r: PORTB_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PB3=`*(r: var PORTB_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTB_OUTTGL_Fields

func PB4*(r: PORTB_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PB4=`*(r: var PORTB_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTB_OUTTGL_Fields

func PB5*(r: PORTB_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PB5=`*(r: var PORTB_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTB_OUTTGL_Fields
...
type
  PORTC_DIR_Fields* = distinct uint8
  PORTC_DIRCLR_Fields* = distinct uint8
  PORTC_DIRSET_Fields* = distinct uint8
  PORTC_DIRTGL_Fields* = distinct uint8
  PORTC_IN_Fields* = distinct uint8
  PORTC_INTFLAGS_Fields* = distinct uint8
  PORTC_OUT_Fields* = distinct uint8
  PORTC_OUTCLR_Fields* = distinct uint8
  PORTC_OUTSET_Fields* = distinct uint8
  PORTC_OUTTGL_Fields* = distinct uint8
...
proc read*(reg: PORTC_DIR_Type): PORTC_DIR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_DIR_Fields](reg.loc))

proc write*(reg: PORTC_DIR_Type, val: PORTC_DIR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_DIR_Fields](reg.loc), val)

proc write*(reg: PORTC_DIR_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
...
proc read*(reg: PORTC_DIRCLR_Type): PORTC_DIRCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_DIRCLR_Fields](reg.loc))

proc write*(reg: PORTC_DIRCLR_Type, val: PORTC_DIRCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_DIRCLR_Fields](reg.loc), val)

proc write*(reg: PORTC_DIRCLR_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_DIRCLR_Fields
...
proc read*(reg: PORTC_DIRSET_Type): PORTC_DIRSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_DIRSET_Fields](reg.loc))

proc write*(reg: PORTC_DIRSET_Type, val: PORTC_DIRSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_DIRSET_Fields](reg.loc), val)

proc write*(reg: PORTC_DIRSET_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_DIRSET_Fields
...
proc read*(reg: PORTC_DIRTGL_Type): PORTC_DIRTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_DIRTGL_Fields](reg.loc))

proc write*(reg: PORTC_DIRTGL_Type, val: PORTC_DIRTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_DIRTGL_Fields](reg.loc), val)

proc write*(reg: PORTC_DIRTGL_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_DIRTGL_Fields
...
proc read*(reg: PORTC_IN_Type): PORTC_IN_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_IN_Fields](reg.loc))

proc write*(reg: PORTC_IN_Type, val: PORTC_IN_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_IN_Fields](reg.loc), val)

proc write*(reg: PORTC_IN_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTC_INTFLAGS_Type): PORTC_INTFLAGS_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_INTFLAGS_Fields](reg.loc))

proc write*(reg: PORTC_INTFLAGS_Type, val: PORTC_INTFLAGS_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_INTFLAGS_Fields](reg.loc), val)

proc write*(reg: PORTC_INTFLAGS_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_INTFLAGS_Fields
...
proc read*(reg: PORTC_OUT_Type): PORTC_OUT_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_OUT_Fields](reg.loc))

proc write*(reg: PORTC_OUT_Type, val: PORTC_OUT_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_OUT_Fields](reg.loc), val)

proc write*(reg: PORTC_OUT_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTC_OUTCLR_Type): PORTC_OUTCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_OUTCLR_Fields](reg.loc))

proc write*(reg: PORTC_OUTCLR_Type, val: PORTC_OUTCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_OUTCLR_Fields](reg.loc), val)

proc write*(reg: PORTC_OUTCLR_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_OUTCLR_Fields
...
proc read*(reg: PORTC_OUTSET_Type): PORTC_OUTSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_OUTSET_Fields](reg.loc))

proc write*(reg: PORTC_OUTSET_Type, val: PORTC_OUTSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_OUTSET_Fields](reg.loc), val)

proc write*(reg: PORTC_OUTSET_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_OUTSET_Fields
...
proc read*(reg: PORTC_OUTTGL_Type): PORTC_OUTTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTC_OUTTGL_Fields](reg.loc))

proc write*(reg: PORTC_OUTTGL_Type, val: PORTC_OUTTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTC_OUTTGL_Fields](reg.loc), val)

proc write*(reg: PORTC_OUTTGL_Type, PC0: bool = false, PC1: bool = false, PC2: bool = false, PC3: bool = false, PC4: bool = false, PC5: bool = false, PC6: bool = false, PC7: bool = false) =
  var x: uint8
  x.setMask((PC0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PC1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PC2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PC6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PC7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTC_OUTTGL_Fields
...
func PC0*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_DIR_Fields

func PC1*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_DIR_Fields

func PC2*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_DIR_Fields

func PC3*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_DIR_Fields

func PC4*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_DIR_Fields

func PC5*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_DIR_Fields

func PC6*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_DIR_Fields

func PC7*(r: PORTC_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_DIR_Fields

func PC0*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_DIRCLR_Fields

func PC1*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_DIRCLR_Fields

func PC2*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_DIRCLR_Fields

func PC3*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_DIRCLR_Fields

func PC4*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_DIRCLR_Fields

func PC5*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_DIRCLR_Fields

func PC6*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_DIRCLR_Fields

func PC7*(r: PORTC_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_DIRCLR_Fields

func PC0*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_DIRSET_Fields

func PC1*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_DIRSET_Fields

func PC2*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_DIRSET_Fields

func PC3*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_DIRSET_Fields

func PC4*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_DIRSET_Fields

func PC5*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_DIRSET_Fields

func PC6*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_DIRSET_Fields

func PC7*(r: PORTC_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_DIRSET_Fields

func PC0*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_DIRTGL_Fields

func PC1*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_DIRTGL_Fields

func PC2*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_DIRTGL_Fields

func PC3*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_DIRTGL_Fields

func PC4*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_DIRTGL_Fields

func PC5*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_DIRTGL_Fields

func PC6*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_DIRTGL_Fields

func PC7*(r: PORTC_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_DIRTGL_Fields

func PC0*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_IN_Fields

func PC1*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_IN_Fields

func PC2*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_IN_Fields

func PC3*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_IN_Fields

func PC4*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_IN_Fields

func PC5*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_IN_Fields

func PC6*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_IN_Fields

func PC7*(r: PORTC_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_IN_Fields

func PC0*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_INTFLAGS_Fields

func PC1*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_INTFLAGS_Fields

func PC2*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_INTFLAGS_Fields

func PC3*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_INTFLAGS_Fields

func PC4*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_INTFLAGS_Fields

func PC5*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_INTFLAGS_Fields

func PC6*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_INTFLAGS_Fields

func PC7*(r: PORTC_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_INTFLAGS_Fields

func PC0*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_OUT_Fields

func PC1*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_OUT_Fields

func PC2*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_OUT_Fields

func PC3*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_OUT_Fields

func PC4*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_OUT_Fields

func PC5*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_OUT_Fields

func PC6*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_OUT_Fields

func PC7*(r: PORTC_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_OUT_Fields

func PC0*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_OUTCLR_Fields

func PC1*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_OUTCLR_Fields

func PC2*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_OUTCLR_Fields

func PC3*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_OUTCLR_Fields

func PC4*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_OUTCLR_Fields

func PC5*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_OUTCLR_Fields

func PC6*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_OUTCLR_Fields

func PC7*(r: PORTC_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_OUTCLR_Fields

func PC0*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_OUTSET_Fields

func PC1*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_OUTSET_Fields

func PC2*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_OUTSET_Fields

func PC3*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_OUTSET_Fields

func PC4*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_OUTSET_Fields

func PC5*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_OUTSET_Fields

func PC6*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_OUTSET_Fields

func PC7*(r: PORTC_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_OUTSET_Fields

func PC0*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PC0=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTC_OUTTGL_Fields

func PC1*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PC1=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTC_OUTTGL_Fields

func PC2*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PC2=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTC_OUTTGL_Fields

func PC3*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PC3=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTC_OUTTGL_Fields

func PC4*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PC4=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTC_OUTTGL_Fields

func PC5*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PC5=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTC_OUTTGL_Fields

func PC6*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PC6=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTC_OUTTGL_Fields

func PC7*(r: PORTC_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PC7=`*(r: var PORTC_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTC_OUTTGL_Fields
...
type
  PORTD_DIR_Fields* = distinct uint8
  PORTD_DIRCLR_Fields* = distinct uint8
  PORTD_DIRSET_Fields* = distinct uint8
  PORTD_DIRTGL_Fields* = distinct uint8
  PORTD_IN_Fields* = distinct uint8
  PORTD_INTFLAGS_Fields* = distinct uint8
  PORTD_OUT_Fields* = distinct uint8
  PORTD_OUTCLR_Fields* = distinct uint8
  PORTD_OUTSET_Fields* = distinct uint8
  PORTD_OUTTGL_Fields* = distinct uint8
...
proc read*(reg: PORTD_DIR_Type): PORTD_DIR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_DIR_Fields](reg.loc))

proc write*(reg: PORTD_DIR_Type, val: PORTD_DIR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_DIR_Fields](reg.loc), val)

proc write*(reg: PORTD_DIR_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
...
proc read*(reg: PORTD_DIRCLR_Type): PORTD_DIRCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_DIRCLR_Fields](reg.loc))

proc write*(reg: PORTD_DIRCLR_Type, val: PORTD_DIRCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_DIRCLR_Fields](reg.loc), val)

proc write*(reg: PORTD_DIRCLR_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_DIRCLR_Fields
...
proc read*(reg: PORTD_DIRSET_Type): PORTD_DIRSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_DIRSET_Fields](reg.loc))

proc write*(reg: PORTD_DIRSET_Type, val: PORTD_DIRSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_DIRSET_Fields](reg.loc), val)

proc write*(reg: PORTD_DIRSET_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_DIRSET_Fields
...
proc read*(reg: PORTD_DIRTGL_Type): PORTD_DIRTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_DIRTGL_Fields](reg.loc))

proc write*(reg: PORTD_DIRTGL_Type, val: PORTD_DIRTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_DIRTGL_Fields](reg.loc), val)

proc write*(reg: PORTD_DIRTGL_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_DIRTGL_Fields
...
proc read*(reg: PORTD_IN_Type): PORTD_IN_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_IN_Fields](reg.loc))

proc write*(reg: PORTD_IN_Type, val: PORTD_IN_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_IN_Fields](reg.loc), val)

proc write*(reg: PORTD_IN_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTD_INTFLAGS_Type): PORTD_INTFLAGS_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_INTFLAGS_Fields](reg.loc))

proc write*(reg: PORTD_INTFLAGS_Type, val: PORTD_INTFLAGS_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_INTFLAGS_Fields](reg.loc), val)

proc write*(reg: PORTD_INTFLAGS_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_INTFLAGS_Fields
...
proc read*(reg: PORTD_OUT_Type): PORTD_OUT_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_OUT_Fields](reg.loc))

proc write*(reg: PORTD_OUT_Type, val: PORTD_OUT_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_OUT_Fields](reg.loc), val)

proc write*(reg: PORTD_OUT_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTD_OUTCLR_Type): PORTD_OUTCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_OUTCLR_Fields](reg.loc))

proc write*(reg: PORTD_OUTCLR_Type, val: PORTD_OUTCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_OUTCLR_Fields](reg.loc), val)

proc write*(reg: PORTD_OUTCLR_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_OUTCLR_Fields
...
proc read*(reg: PORTD_OUTSET_Type): PORTD_OUTSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_OUTSET_Fields](reg.loc))

proc write*(reg: PORTD_OUTSET_Type, val: PORTD_OUTSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_OUTSET_Fields](reg.loc), val)

proc write*(reg: PORTD_OUTSET_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_OUTSET_Fields
...
proc read*(reg: PORTD_OUTTGL_Type): PORTD_OUTTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTD_OUTTGL_Fields](reg.loc))

proc write*(reg: PORTD_OUTTGL_Type, val: PORTD_OUTTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTD_OUTTGL_Fields](reg.loc), val)

proc write*(reg: PORTD_OUTTGL_Type, PD0: bool = false, PD1: bool = false, PD2: bool = false, PD3: bool = false, PD4: bool = false, PD5: bool = false, PD6: bool = false, PD7: bool = false) =
  var x: uint8
  x.setMask((PD0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PD1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PD2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PD6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PD7.uint8 shl 7).masked(7 .. 7))
  reg.write x.PORTD_OUTTGL_Fields
...
func PD0*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_DIR_Fields

func PD1*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_DIR_Fields

func PD2*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_DIR_Fields

func PD3*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_DIR_Fields

func PD4*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_DIR_Fields

func PD5*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_DIR_Fields

func PD6*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_DIR_Fields

func PD7*(r: PORTD_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_DIR_Fields

func PD0*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_DIRCLR_Fields

func PD1*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_DIRCLR_Fields

func PD2*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_DIRCLR_Fields

func PD3*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_DIRCLR_Fields

func PD4*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_DIRCLR_Fields

func PD5*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_DIRCLR_Fields

func PD6*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_DIRCLR_Fields

func PD7*(r: PORTD_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_DIRCLR_Fields

func PD0*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_DIRSET_Fields

func PD1*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_DIRSET_Fields

func PD2*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_DIRSET_Fields

func PD3*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_DIRSET_Fields

func PD4*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_DIRSET_Fields

func PD5*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_DIRSET_Fields

func PD6*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_DIRSET_Fields

func PD7*(r: PORTD_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_DIRSET_Fields

func PD0*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_DIRTGL_Fields

func PD1*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_DIRTGL_Fields

func PD2*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_DIRTGL_Fields

func PD3*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_DIRTGL_Fields

func PD4*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_DIRTGL_Fields

func PD5*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_DIRTGL_Fields

func PD6*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_DIRTGL_Fields

func PD7*(r: PORTD_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_DIRTGL_Fields

func PD0*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_IN_Fields

func PD1*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_IN_Fields

func PD2*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_IN_Fields

func PD3*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_IN_Fields

func PD4*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_IN_Fields

func PD5*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_IN_Fields

func PD6*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_IN_Fields

func PD7*(r: PORTD_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_IN_Fields

func PD0*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_INTFLAGS_Fields

func PD1*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_INTFLAGS_Fields

func PD2*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_INTFLAGS_Fields

func PD3*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_INTFLAGS_Fields

func PD4*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_INTFLAGS_Fields

func PD5*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_INTFLAGS_Fields

func PD6*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_INTFLAGS_Fields

func PD7*(r: PORTD_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_INTFLAGS_Fields

func PD0*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_OUT_Fields

func PD1*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_OUT_Fields

func PD2*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_OUT_Fields

func PD3*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_OUT_Fields

func PD4*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_OUT_Fields

func PD5*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_OUT_Fields

func PD6*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_OUT_Fields

func PD7*(r: PORTD_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_OUT_Fields

func PD0*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_OUTCLR_Fields

func PD1*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_OUTCLR_Fields

func PD2*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_OUTCLR_Fields

func PD3*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_OUTCLR_Fields

func PD4*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_OUTCLR_Fields

func PD5*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_OUTCLR_Fields

func PD6*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_OUTCLR_Fields

func PD7*(r: PORTD_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_OUTCLR_Fields

func PD0*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_OUTSET_Fields

func PD1*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_OUTSET_Fields

func PD2*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_OUTSET_Fields

func PD3*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_OUTSET_Fields

func PD4*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_OUTSET_Fields

func PD5*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_OUTSET_Fields

func PD6*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_OUTSET_Fields

func PD7*(r: PORTD_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_OUTSET_Fields

func PD0*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PD0=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTD_OUTTGL_Fields

func PD1*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PD1=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTD_OUTTGL_Fields

func PD2*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PD2=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTD_OUTTGL_Fields

func PD3*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PD3=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTD_OUTTGL_Fields

func PD4*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PD4=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTD_OUTTGL_Fields

func PD5*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PD5=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTD_OUTTGL_Fields

func PD6*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PD6=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTD_OUTTGL_Fields

func PD7*(r: PORTD_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PD7=`*(r: var PORTD_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.PORTD_OUTTGL_Fields
...
type
  PORTE_DIR_Fields* = distinct uint8
  PORTE_DIRCLR_Fields* = distinct uint8
  PORTE_DIRSET_Fields* = distinct uint8
  PORTE_DIRTGL_Fields* = distinct uint8
  PORTE_IN_Fields* = distinct uint8
  PORTE_INTFLAGS_Fields* = distinct uint8
  PORTE_OUT_Fields* = distinct uint8
  PORTE_OUTCLR_Fields* = distinct uint8
  PORTE_OUTSET_Fields* = distinct uint8
  PORTE_OUTTGL_Fields* = distinct uint8
...
proc read*(reg: PORTE_DIR_Type): PORTE_DIR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_DIR_Fields](reg.loc))

proc write*(reg: PORTE_DIR_Type, val: PORTE_DIR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_DIR_Fields](reg.loc), val)

proc write*(reg: PORTE_DIR_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
...
proc read*(reg: PORTE_DIRCLR_Type): PORTE_DIRCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_DIRCLR_Fields](reg.loc))

proc write*(reg: PORTE_DIRCLR_Type, val: PORTE_DIRCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_DIRCLR_Fields](reg.loc), val)

proc write*(reg: PORTE_DIRCLR_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_DIRCLR_Fields
...
proc read*(reg: PORTE_DIRSET_Type): PORTE_DIRSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_DIRSET_Fields](reg.loc))

proc write*(reg: PORTE_DIRSET_Type, val: PORTE_DIRSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_DIRSET_Fields](reg.loc), val)

proc write*(reg: PORTE_DIRSET_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_DIRSET_Fields
...
proc read*(reg: PORTE_DIRTGL_Type): PORTE_DIRTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_DIRTGL_Fields](reg.loc))

proc write*(reg: PORTE_DIRTGL_Type, val: PORTE_DIRTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_DIRTGL_Fields](reg.loc), val)

proc write*(reg: PORTE_DIRTGL_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_DIRTGL_Fields
...
proc read*(reg: PORTE_IN_Type): PORTE_IN_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_IN_Fields](reg.loc))

proc write*(reg: PORTE_IN_Type, val: PORTE_IN_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_IN_Fields](reg.loc), val)

proc write*(reg: PORTE_IN_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_IN_Fields
...
proc read*(reg: PORTE_INTFLAGS_Type): PORTE_INTFLAGS_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_INTFLAGS_Fields](reg.loc))

proc write*(reg: PORTE_INTFLAGS_Type, val: PORTE_INTFLAGS_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_INTFLAGS_Fields](reg.loc), val)

proc write*(reg: PORTE_INTFLAGS_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_INTFLAGS_Fields
...
proc read*(reg: PORTE_OUT_Type): PORTE_OUT_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_OUT_Fields](reg.loc))

proc write*(reg: PORTE_OUT_Type, val: PORTE_OUT_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_OUT_Fields](reg.loc), val)

proc write*(reg: PORTE_OUT_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_OUT_Fields
...
proc read*(reg: PORTE_OUTCLR_Type): PORTE_OUTCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_OUTCLR_Fields](reg.loc))

proc write*(reg: PORTE_OUTCLR_Type, val: PORTE_OUTCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_OUTCLR_Fields](reg.loc), val)

proc write*(reg: PORTE_OUTCLR_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_OUTCLR_Fields
...
proc read*(reg: PORTE_OUTSET_Type): PORTE_OUTSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_OUTSET_Fields](reg.loc))

proc write*(reg: PORTE_OUTSET_Type, val: PORTE_OUTSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_OUTSET_Fields](reg.loc), val)

proc write*(reg: PORTE_OUTSET_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_OUTSET_Fields
...
proc read*(reg: PORTE_OUTTGL_Type): PORTE_OUTTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTE_OUTTGL_Fields](reg.loc))

proc write*(reg: PORTE_OUTTGL_Type, val: PORTE_OUTTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTE_OUTTGL_Fields](reg.loc), val)

proc write*(reg: PORTE_OUTTGL_Type, PE0: bool = false, PE1: bool = false, PE2: bool = false, PE3: bool = false) =
  var x: uint8
  x.setMask((PE0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PE1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PE2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PE3.uint8 shl 3).masked(3 .. 3))
  reg.write x.PORTE_OUTTGL_Fields
...
func PE0*(r: PORTE_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_DIR_Fields

func PE1*(r: PORTE_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_DIR_Fields

func PE2*(r: PORTE_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_DIR_Fields

func PE3*(r: PORTE_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_DIR_Fields

func PE0*(r: PORTE_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_DIRCLR_Fields

func PE1*(r: PORTE_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_DIRCLR_Fields

func PE2*(r: PORTE_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_DIRCLR_Fields

func PE3*(r: PORTE_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_DIRCLR_Fields

func PE0*(r: PORTE_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_DIRSET_Fields

func PE1*(r: PORTE_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_DIRSET_Fields

func PE2*(r: PORTE_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_DIRSET_Fields

func PE3*(r: PORTE_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_DIRSET_Fields

func PE0*(r: PORTE_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_DIRTGL_Fields

func PE1*(r: PORTE_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_DIRTGL_Fields

func PE2*(r: PORTE_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_DIRTGL_Fields

func PE3*(r: PORTE_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_DIRTGL_Fields

func PE0*(r: PORTE_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_IN_Fields

func PE1*(r: PORTE_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_IN_Fields

func PE2*(r: PORTE_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_IN_Fields

func PE3*(r: PORTE_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_IN_Fields

func PE0*(r: PORTE_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_INTFLAGS_Fields

func PE1*(r: PORTE_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_INTFLAGS_Fields

func PE2*(r: PORTE_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_INTFLAGS_Fields

func PE3*(r: PORTE_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_INTFLAGS_Fields

func PE0*(r: PORTE_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_OUT_Fields

func PE1*(r: PORTE_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_OUT_Fields

func PE2*(r: PORTE_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_OUT_Fields

func PE3*(r: PORTE_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_OUT_Fields

func PE0*(r: PORTE_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_OUTCLR_Fields

func PE1*(r: PORTE_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_OUTCLR_Fields

func PE2*(r: PORTE_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_OUTCLR_Fields

func PE3*(r: PORTE_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_OUTCLR_Fields

func PE0*(r: PORTE_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_OUTSET_Fields

func PE1*(r: PORTE_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_OUTSET_Fields

func PE2*(r: PORTE_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_OUTSET_Fields

func PE3*(r: PORTE_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_OUTSET_Fields

func PE0*(r: PORTE_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PE0=`*(r: var PORTE_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTE_OUTTGL_Fields

func PE1*(r: PORTE_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PE1=`*(r: var PORTE_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTE_OUTTGL_Fields

func PE2*(r: PORTE_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PE2=`*(r: var PORTE_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTE_OUTTGL_Fields

func PE3*(r: PORTE_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PE3=`*(r: var PORTE_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTE_OUTTGL_Fields
...
type
  PORTF_DIR_Fields* = distinct uint8
  PORTF_DIRCLR_Fields* = distinct uint8
  PORTF_DIRSET_Fields* = distinct uint8
  PORTF_DIRTGL_Fields* = distinct uint8
  PORTF_IN_Fields* = distinct uint8
  PORTF_INTFLAGS_Fields* = distinct uint8
  PORTF_OUT_Fields* = distinct uint8
  PORTF_OUTCLR_Fields* = distinct uint8
  PORTF_OUTSET_Fields* = distinct uint8
  PORTF_OUTTGL_Fields* = distinct uint8
...
proc read*(reg: PORTF_DIR_Type): PORTF_DIR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_DIR_Fields](reg.loc))

proc write*(reg: PORTF_DIR_Type, val: PORTF_DIR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_DIR_Fields](reg.loc), val)

proc write*(reg: PORTF_DIR_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
...
proc read*(reg: PORTF_DIRCLR_Type): PORTF_DIRCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_DIRCLR_Fields](reg.loc))

proc write*(reg: PORTF_DIRCLR_Type, val: PORTF_DIRCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_DIRCLR_Fields](reg.loc), val)

proc write*(reg: PORTF_DIRCLR_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_DIRCLR_Fields
...
proc read*(reg: PORTF_DIRSET_Type): PORTF_DIRSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_DIRSET_Fields](reg.loc))

proc write*(reg: PORTF_DIRSET_Type, val: PORTF_DIRSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_DIRSET_Fields](reg.loc), val)

proc write*(reg: PORTF_DIRSET_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_DIRSET_Fields
...
proc read*(reg: PORTF_DIRTGL_Type): PORTF_DIRTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_DIRTGL_Fields](reg.loc))

proc write*(reg: PORTF_DIRTGL_Type, val: PORTF_DIRTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_DIRTGL_Fields](reg.loc), val)

proc write*(reg: PORTF_DIRTGL_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_DIRTGL_Fields
...
proc read*(reg: PORTF_IN_Type): PORTF_IN_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_IN_Fields](reg.loc))

proc write*(reg: PORTF_IN_Type, val: PORTF_IN_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_IN_Fields](reg.loc), val)

proc write*(reg: PORTF_IN_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTF_INTFLAGS_Type): PORTF_INTFLAGS_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_INTFLAGS_Fields](reg.loc))

proc write*(reg: PORTF_INTFLAGS_Type, val: PORTF_INTFLAGS_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_INTFLAGS_Fields](reg.loc), val)

proc write*(reg: PORTF_INTFLAGS_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_INTFLAGS_Fields
...
proc read*(reg: PORTF_OUT_Type): PORTF_OUT_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_OUT_Fields](reg.loc))

proc write*(reg: PORTF_OUT_Type, val: PORTF_OUT_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_OUT_Fields](reg.loc), val)

proc write*(reg: PORTF_OUT_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
...
proc read*(reg: PORTF_OUTCLR_Type): PORTF_OUTCLR_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_OUTCLR_Fields](reg.loc))

proc write*(reg: PORTF_OUTCLR_Type, val: PORTF_OUTCLR_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_OUTCLR_Fields](reg.loc), val)

proc write*(reg: PORTF_OUTCLR_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_OUTCLR_Fields
...
proc read*(reg: PORTF_OUTSET_Type): PORTF_OUTSET_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_OUTSET_Fields](reg.loc))

proc write*(reg: PORTF_OUTSET_Type, val: PORTF_OUTSET_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_OUTSET_Fields](reg.loc), val)

proc write*(reg: PORTF_OUTSET_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_OUTSET_Fields
...
proc read*(reg: PORTF_OUTTGL_Type): PORTF_OUTTGL_Fields {.inline.} =
  volatileLoad(cast[ptr PORTF_OUTTGL_Fields](reg.loc))

proc write*(reg: PORTF_OUTTGL_Type, val: PORTF_OUTTGL_Fields) {.inline.} =
  volatileStore(cast[ptr PORTF_OUTTGL_Fields](reg.loc), val)

proc write*(reg: PORTF_OUTTGL_Type, PF0: bool = false, PF1: bool = false, PF2: bool = false, PF3: bool = false, PF4: bool = false, PF5: bool = false, PF6: bool = false) =
  var x: uint8
  x.setMask((PF0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PF1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PF2.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PF5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PF6.uint8 shl 6).masked(6 .. 6))
  reg.write x.PORTF_OUTTGL_Fields
...
func PF0*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_DIR_Fields

func PF1*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_DIR_Fields

func PF2*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_DIR_Fields

func PF3*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_DIR_Fields

func PF4*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_DIR_Fields

func PF5*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_DIR_Fields

func PF6*(r: PORTF_DIR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_DIR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_DIR_Fields

func PF0*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_DIRCLR_Fields

func PF1*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_DIRCLR_Fields

func PF2*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_DIRCLR_Fields

func PF3*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_DIRCLR_Fields

func PF4*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_DIRCLR_Fields

func PF5*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_DIRCLR_Fields

func PF6*(r: PORTF_DIRCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_DIRCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_DIRCLR_Fields

func PF0*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_DIRSET_Fields

func PF1*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_DIRSET_Fields

func PF2*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_DIRSET_Fields

func PF3*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_DIRSET_Fields

func PF4*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_DIRSET_Fields

func PF5*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_DIRSET_Fields

func PF6*(r: PORTF_DIRSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_DIRSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_DIRSET_Fields

func PF0*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_DIRTGL_Fields

func PF1*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_DIRTGL_Fields

func PF2*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_DIRTGL_Fields

func PF3*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_DIRTGL_Fields

func PF4*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_DIRTGL_Fields

func PF5*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_DIRTGL_Fields

func PF6*(r: PORTF_DIRTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_DIRTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_DIRTGL_Fields

func PF0*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_IN_Fields

func PF1*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_IN_Fields

func PF2*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_IN_Fields

func PF3*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_IN_Fields

func PF4*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_IN_Fields

func PF5*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_IN_Fields

func PF6*(r: PORTF_IN_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_IN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_IN_Fields

func PF0*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_INTFLAGS_Fields

func PF1*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_INTFLAGS_Fields

func PF2*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_INTFLAGS_Fields

func PF3*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_INTFLAGS_Fields

func PF4*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_INTFLAGS_Fields

func PF5*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_INTFLAGS_Fields

func PF6*(r: PORTF_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_INTFLAGS_Fields

func PF0*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_OUT_Fields

func PF1*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_OUT_Fields

func PF2*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_OUT_Fields

func PF3*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_OUT_Fields

func PF4*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_OUT_Fields

func PF5*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_OUT_Fields

func PF6*(r: PORTF_OUT_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_OUT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_OUT_Fields

func PF0*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_OUTCLR_Fields

func PF1*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_OUTCLR_Fields

func PF2*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_OUTCLR_Fields

func PF3*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_OUTCLR_Fields

func PF4*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_OUTCLR_Fields

func PF5*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_OUTCLR_Fields

func PF6*(r: PORTF_OUTCLR_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_OUTCLR_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_OUTCLR_Fields

func PF0*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_OUTSET_Fields

func PF1*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_OUTSET_Fields

func PF2*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_OUTSET_Fields

func PF3*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_OUTSET_Fields

func PF4*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_OUTSET_Fields

func PF5*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_OUTSET_Fields

func PF6*(r: PORTF_OUTSET_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_OUTSET_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_OUTSET_Fields

func PF0*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PF0=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.PORTF_OUTTGL_Fields

func PF1*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PF1=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTF_OUTTGL_Fields

func PF2*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PF2=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.PORTF_OUTTGL_Fields

func PF3*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PF3=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTF_OUTTGL_Fields

func PF4*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PF4=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTF_OUTTGL_Fields

func PF5*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PF5=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.PORTF_OUTTGL_Fields

func PF6*(r: PORTF_OUTTGL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PF6=`*(r: var PORTF_OUTTGL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.PORTF_OUTTGL_Fields
...
type PORTMUX_EVSYSROUTEA_EVOUTB* {.size: 1.} = enum
  DEFAULT = 0x0,
...
type PORTMUX_EVSYSROUTEA_EVOUTE* {.size: 1.} = enum
  DEFAULT = 0x0,
...
proc write*(reg: PORTMUX_EVSYSROUTEA_Type, EVOUTA: PORTMUX_EVSYSROUTEA_EVOUTA = DEFAULT, EVOUTB: PORTMUX_EVSYSROUTEA_EVOUTB = DEFAULT, EVOUTC: PORTMUX_EVSYSROUTEA_EVOUTC = DEFAULT, EVOUTD: PORTMUX_EVSYSROUTEA_EVOUTD = DEFAULT, EVOUTE: PORTMUX_EVSYSROUTEA_EVOUTE = DEFAULT, EVOUTF: PORTMUX_EVSYSROUTEA_EVOUTF = DEFAULT) =
  var x: uint8
  x.setMask((EVOUTA.uint8 shl 0).masked(0 .. 0))
  x.setMask((EVOUTB.uint8 shl 1).masked(1 .. 1))
  x.setMask((EVOUTC.uint8 shl 2).masked(2 .. 2))
  x.setMask((EVOUTD.uint8 shl 3).masked(3 .. 3))
  x.setMask((EVOUTE.uint8 shl 4).masked(4 .. 4))
...
proc write*(reg: PORTMUX_TCBROUTEA_Type, TCB0: PORTMUX_TCBROUTEA_TCB0 = DEFAULT, TCB1: PORTMUX_TCBROUTEA_TCB1 = DEFAULT, TCB2: PORTMUX_TCBROUTEA_TCB2 = DEFAULT, TCB3: PORTMUX_TCBROUTEA_TCB3 = DEFAULT) =
  var x: uint8
...
func EVOUTB*(r: PORTMUX_EVSYSROUTEA_Fields): UncheckedEnum[PORTMUX_EVSYSROUTEA_EVOUTB] {.inline.} =
  toUncheckedEnum[PORTMUX_EVSYSROUTEA_EVOUTB](r.uint8.bitsliced(1 .. 1).int)

proc `EVOUTB=`*(r: var PORTMUX_EVSYSROUTEA_Fields, val: PORTMUX_EVSYSROUTEA_EVOUTB) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.PORTMUX_EVSYSROUTEA_Fields
...
func EVOUTE*(r: PORTMUX_EVSYSROUTEA_Fields): UncheckedEnum[PORTMUX_EVSYSROUTEA_EVOUTE] {.inline.} =
  toUncheckedEnum[PORTMUX_EVSYSROUTEA_EVOUTE](r.uint8.bitsliced(4 .. 4).int)

proc `EVOUTE=`*(r: var PORTMUX_EVSYSROUTEA_Fields, val: PORTMUX_EVSYSROUTEA_EVOUTE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.PORTMUX_EVSYSROUTEA_Fields
...
func TCB3Field*(r: PORTMUX_TCBROUTEA_Fields): UncheckedEnum[PORTMUX_TCBROUTEA_TCB3] {.inline.} =
  toUncheckedEnum[PORTMUX_TCBROUTEA_TCB3](r.uint8.bitsliced(3 .. 3).int)

proc `TCB3Field=`*(r: var PORTMUX_TCBROUTEA_Fields, val: PORTMUX_TCBROUTEA_TCB3) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.PORTMUX_TCBROUTEA_Fields
...
func USART3Field*(r: PORTMUX_USARTROUTEA_Fields): UncheckedEnum[PORTMUX_USARTROUTEA_USART3] {.inline.} =
  toUncheckedEnum[PORTMUX_USARTROUTEA_USART3](r.uint8.bitsliced(6 .. 7).int)

proc `USART3Field=`*(r: var PORTMUX_USARTROUTEA_Fields, val: PORTMUX_USARTROUTEA_USART3) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 7)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 7))
  r = tmp.PORTMUX_USARTROUTEA_Fields
...
type
  TCB3_CTRLA_Fields* = distinct uint8
  TCB3_CTRLB_Fields* = distinct uint8
  TCB3_DBGCTRL_Fields* = distinct uint8
  TCB3_EVCTRL_Fields* = distinct uint8
  TCB3_INTCTRL_Fields* = distinct uint8
  TCB3_INTFLAGS_Fields* = distinct uint8
  TCB3_STATUS_Fields* = distinct uint8

type TCB3_CTRLA_CLKSEL* {.size: 1.} = enum
  CLKDIV1 = 0x0,
  CLKDIV2 = 0x1,
  CLKTCA = 0x2,

type TCB3_CTRLB_CNTMODE* {.size: 1.} = enum
  INT = 0x0,
  TIMEOUT = 0x1,
  CAPT = 0x2,
  FRQ = 0x3,
...
proc read*(reg: TCB3_CCMP_Type): uint16 {.inline.} =
  volatileLoad(cast[ptr uint16](reg.loc))

proc write*(reg: TCB3_CCMP_Type, val: uint16) {.inline.} =
  volatileStore(cast[ptr uint16](reg.loc), val)

template modifyIt*(reg: TCB3_CCMP_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_CNT_Type): uint16 {.inline.} =
  volatileLoad(cast[ptr uint16](reg.loc))

proc write*(reg: TCB3_CNT_Type, val: uint16) {.inline.} =
  volatileStore(cast[ptr uint16](reg.loc), val)

template modifyIt*(reg: TCB3_CNT_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_CTRLA_Type): TCB3_CTRLA_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_CTRLA_Fields](reg.loc))

proc write*(reg: TCB3_CTRLA_Type, val: TCB3_CTRLA_Fields) {.inline.} =
  volatileStore(cast[ptr TCB3_CTRLA_Fields](reg.loc), val)

proc write*(reg: TCB3_CTRLA_Type, ENABLE: bool = false, CLKSEL: TCB3_CTRLA_CLKSEL = CLKDIV1, SYNCUPD: bool = false, RUNSTDBY: bool = false) =
  var x: uint8
  x.setMask((ENABLE.uint8 shl 0).masked(0 .. 0))
  x.setMask((CLKSEL.uint8 shl 1).masked(1 .. 2))
  x.setMask((SYNCUPD.uint8 shl 4).masked(4 .. 4))
  x.setMask((RUNSTDBY.uint8 shl 6).masked(6 .. 6))
  reg.write x.TCB3_CTRLA_Fields

template modifyIt*(reg: TCB3_CTRLA_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_CTRLB_Type): TCB3_CTRLB_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_CTRLB_Fields](reg.loc))

proc write*(reg: TCB3_CTRLB_Type, val: TCB3_CTRLB_Fields) {.inline.} =
  volatileStore(cast[ptr TCB3_CTRLB_Fields](reg.loc), val)

proc write*(reg: TCB3_CTRLB_Type, CNTMODE: TCB3_CTRLB_CNTMODE = INT, CCMPEN: bool = false, CCMPINIT: bool = false, ASYNC: bool = false) =
  var x: uint8
  x.setMask((CNTMODE.uint8 shl 0).masked(0 .. 2))
  x.setMask((CCMPEN.uint8 shl 4).masked(4 .. 4))
  x.setMask((CCMPINIT.uint8 shl 5).masked(5 .. 5))
  x.setMask((ASYNC.uint8 shl 6).masked(6 .. 6))
  reg.write x.TCB3_CTRLB_Fields

template modifyIt*(reg: TCB3_CTRLB_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_DBGCTRL_Type): TCB3_DBGCTRL_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_DBGCTRL_Fields](reg.loc))

proc write*(reg: TCB3_DBGCTRL_Type, val: TCB3_DBGCTRL_Fields) {.inline.} =
  volatileStore(cast[ptr TCB3_DBGCTRL_Fields](reg.loc), val)

proc write*(reg: TCB3_DBGCTRL_Type, DBGRUN: bool = false) =
  var x: uint8
  x.setMask((DBGRUN.uint8 shl 0).masked(0 .. 0))
  reg.write x.TCB3_DBGCTRL_Fields

template modifyIt*(reg: TCB3_DBGCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_EVCTRL_Type): TCB3_EVCTRL_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_EVCTRL_Fields](reg.loc))

proc write*(reg: TCB3_EVCTRL_Type, val: TCB3_EVCTRL_Fields) {.inline.} =
  volatileStore(cast[ptr TCB3_EVCTRL_Fields](reg.loc), val)

proc write*(reg: TCB3_EVCTRL_Type, CAPTEI: bool = false, EDGE: bool = false, FILTER: bool = false) =
  var x: uint8
  x.setMask((CAPTEI.uint8 shl 0).masked(0 .. 0))
  x.setMask((EDGE.uint8 shl 4).masked(4 .. 4))
  x.setMask((FILTER.uint8 shl 6).masked(6 .. 6))
  reg.write x.TCB3_EVCTRL_Fields

template modifyIt*(reg: TCB3_EVCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_INTCTRL_Type): TCB3_INTCTRL_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_INTCTRL_Fields](reg.loc))

proc write*(reg: TCB3_INTCTRL_Type, val: TCB3_INTCTRL_Fields) {.inline.} =
  volatileStore(cast[ptr TCB3_INTCTRL_Fields](reg.loc), val)

proc write*(reg: TCB3_INTCTRL_Type, CAPT: bool = false) =
  var x: uint8
  x.setMask((CAPT.uint8 shl 0).masked(0 .. 0))
  reg.write x.TCB3_INTCTRL_Fields

template modifyIt*(reg: TCB3_INTCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_INTFLAGS_Type): TCB3_INTFLAGS_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_INTFLAGS_Fields](reg.loc))

proc write*(reg: TCB3_INTFLAGS_Type, val: TCB3_INTFLAGS_Fields) {.inline.} =
  volatileStore(cast[ptr TCB3_INTFLAGS_Fields](reg.loc), val)

proc write*(reg: TCB3_INTFLAGS_Type, CAPT: bool = false) =
  var x: uint8
  x.setMask((CAPT.uint8 shl 0).masked(0 .. 0))
  reg.write x.TCB3_INTFLAGS_Fields

template modifyIt*(reg: TCB3_INTFLAGS_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: TCB3_STATUS_Type): TCB3_STATUS_Fields {.inline.} =
  volatileLoad(cast[ptr TCB3_STATUS_Fields](reg.loc))

proc read*(reg: TCB3_TEMP_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: TCB3_TEMP_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: TCB3_TEMP_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

func ENABLE*(r: TCB3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `ENABLE=`*(r: var TCB3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.TCB3_CTRLA_Fields

func CLKSEL*(r: TCB3_CTRLA_Fields): UncheckedEnum[TCB3_CTRLA_CLKSEL] {.inline.} =
  toUncheckedEnum[TCB3_CTRLA_CLKSEL](r.uint8.bitsliced(1 .. 2).int)

proc `CLKSEL=`*(r: var TCB3_CTRLA_Fields, val: TCB3_CTRLA_CLKSEL) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 2)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 2))
  r = tmp.TCB3_CTRLA_Fields

func SYNCUPD*(r: TCB3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SYNCUPD=`*(r: var TCB3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.TCB3_CTRLA_Fields

func RUNSTDBY*(r: TCB3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `RUNSTDBY=`*(r: var TCB3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.TCB3_CTRLA_Fields

func CNTMODE*(r: TCB3_CTRLB_Fields): UncheckedEnum[TCB3_CTRLB_CNTMODE] {.inline.} =
  toUncheckedEnum[TCB3_CTRLB_CNTMODE](r.uint8.bitsliced(0 .. 2).int)

proc `CNTMODE=`*(r: var TCB3_CTRLB_Fields, val: TCB3_CTRLB_CNTMODE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 2)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 2))
  r = tmp.TCB3_CTRLB_Fields

func CCMPEN*(r: TCB3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `CCMPEN=`*(r: var TCB3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.TCB3_CTRLB_Fields

func CCMPINIT*(r: TCB3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `CCMPINIT=`*(r: var TCB3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.TCB3_CTRLB_Fields

func ASYNC*(r: TCB3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `ASYNC=`*(r: var TCB3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.TCB3_CTRLB_Fields

func DBGRUN*(r: TCB3_DBGCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `DBGRUN=`*(r: var TCB3_DBGCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.TCB3_DBGCTRL_Fields

func CAPTEI*(r: TCB3_EVCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `CAPTEI=`*(r: var TCB3_EVCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.TCB3_EVCTRL_Fields

func EDGE*(r: TCB3_EVCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `EDGE=`*(r: var TCB3_EVCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.TCB3_EVCTRL_Fields

func FILTER*(r: TCB3_EVCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `FILTER=`*(r: var TCB3_EVCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.TCB3_EVCTRL_Fields

func CAPT*(r: TCB3_INTCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `CAPT=`*(r: var TCB3_INTCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.TCB3_INTCTRL_Fields

func CAPT*(r: TCB3_INTFLAGS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `CAPT=`*(r: var TCB3_INTFLAGS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.TCB3_INTFLAGS_Fields

func RUN*(r: TCB3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool
...
type
  USART3_CTRLA_Fields* = distinct uint8
  USART3_CTRLB_Fields* = distinct uint8
  USART3_CTRLC_Fields* = distinct uint8
  USART3_CTRLD_Fields* = distinct uint8
  USART3_DBGCTRL_Fields* = distinct uint8
  USART3_EVCTRL_Fields* = distinct uint8
  USART3_RXDATAH_Fields* = distinct uint8
  USART3_RXPLCTRL_Fields* = distinct uint8
  USART3_STATUS_Fields* = distinct uint8
  USART3_TXDATAH_Fields* = distinct uint8

type USART3_CTRLA_RS485* {.size: 1.} = enum
  OFF = 0x0,
  EXT = 0x1,
  INT = 0x2,

type USART3_CTRLB_RXMODE* {.size: 1.} = enum
  NORMAL = 0x0,
  CLK2X = 0x1,
  GENAUTO = 0x2,
  LINAUTO = 0x3,

type USART3_CTRLC_CHSIZE* {.size: 1.} = enum
  x5BIT = 0x0,
  x6BIT = 0x1,
  x7BIT = 0x2,
  x8BIT = 0x3,
...
type USART3_CTRLC_SBMODE* {.size: 1.} = enum
  x1BIT = 0x0,
  x2BIT = 0x1,

type USART3_CTRLC_PMODE* {.size: 1.} = enum
  DISABLED = 0x0,
  EVEN = 0x2,
  ODD = 0x3,

type USART3_CTRLC_CMODE* {.size: 1.} = enum
  ASYNCHRONOUS = 0x0,
  SYNCHRONOUS = 0x1,
  IRCOM = 0x2,
  MSPI = 0x3,

type USART3_CTRLD_ABW* {.size: 1.} = enum
  WDW0 = 0x0,
  WDW1 = 0x1,
  WDW2 = 0x2,
  WDW3 = 0x3,

proc read*(reg: USART3_BAUD_Type): uint16 {.inline.} =
  volatileLoad(cast[ptr uint16](reg.loc))

proc write*(reg: USART3_BAUD_Type, val: uint16) {.inline.} =
  volatileStore(cast[ptr uint16](reg.loc), val)

template modifyIt*(reg: USART3_BAUD_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_CTRLA_Type): USART3_CTRLA_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_CTRLA_Fields](reg.loc))

proc write*(reg: USART3_CTRLA_Type, val: USART3_CTRLA_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_CTRLA_Fields](reg.loc), val)

proc write*(reg: USART3_CTRLA_Type, RS485: USART3_CTRLA_RS485 = OFF, ABEIE: bool = false, LBME: bool = false, RXSIE: bool = false, DREIE: bool = false, TXCIE: bool = false, RXCIE: bool = false) =
  var x: uint8
  x.setMask((RS485.uint8 shl 0).masked(0 .. 1))
  x.setMask((ABEIE.uint8 shl 2).masked(2 .. 2))
  x.setMask((LBME.uint8 shl 3).masked(3 .. 3))
  ...
  x.setMask((TXCIE.uint8 shl 6).masked(6 .. 6))
  x.setMask((RXCIE.uint8 shl 7).masked(7 .. 7))
  reg.write x.USART3_CTRLA_Fields

template modifyIt*(reg: USART3_CTRLA_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_CTRLB_Type): USART3_CTRLB_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_CTRLB_Fields](reg.loc))

proc write*(reg: USART3_CTRLB_Type, val: USART3_CTRLB_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_CTRLB_Fields](reg.loc), val)

proc write*(reg: USART3_CTRLB_Type, MPCM: bool = false, RXMODE: USART3_CTRLB_RXMODE = NORMAL, ODME: bool = false, SFDEN: bool = false, TXEN: bool = false, RXEN: bool = false) =
  var x: uint8
  x.setMask((MPCM.uint8 shl 0).masked(0 .. 0))
  x.setMask((RXMODE.uint8 shl 1).masked(1 .. 2))
  x.setMask((ODME.uint8 shl 3).masked(3 .. 3))
  ...
  x.setMask((TXEN.uint8 shl 6).masked(6 .. 6))
  x.setMask((RXEN.uint8 shl 7).masked(7 .. 7))
  reg.write x.USART3_CTRLB_Fields

template modifyIt*(reg: USART3_CTRLB_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_CTRLC_Type): USART3_CTRLC_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_CTRLC_Fields](reg.loc))

proc write*(reg: USART3_CTRLC_Type, val: USART3_CTRLC_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_CTRLC_Fields](reg.loc), val)

proc write*(reg: USART3_CTRLC_Type, CHSIZE: USART3_CTRLC_CHSIZE = x5BIT, UCPHA: bool = false, UDORD: bool = false, SBMODE: USART3_CTRLC_SBMODE = x1BIT, PMODE: USART3_CTRLC_PMODE = DISABLED, CMODE: USART3_CTRLC_CMODE = ASYNCHRONOUS) =
  var x: uint8
  x.setMask((CHSIZE.uint8 shl 0).masked(0 .. 2))
  x.setMask((UCPHA.uint8 shl 1).masked(1 .. 1))
  x.setMask((UDORD.uint8 shl 2).masked(2 .. 2))
  ...
  x.setMask((PMODE.uint8 shl 4).masked(4 .. 5))
  x.setMask((CMODE.uint8 shl 6).masked(6 .. 7))
  reg.write x.USART3_CTRLC_Fields

template modifyIt*(reg: USART3_CTRLC_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_CTRLD_Type): USART3_CTRLD_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_CTRLD_Fields](reg.loc))

proc write*(reg: USART3_CTRLD_Type, val: USART3_CTRLD_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_CTRLD_Fields](reg.loc), val)

proc write*(reg: USART3_CTRLD_Type, ABW: USART3_CTRLD_ABW = WDW0) =
  var x: uint8
  x.setMask((ABW.uint8 shl 6).masked(6 .. 7))
  reg.write x.USART3_CTRLD_Fields

template modifyIt*(reg: USART3_CTRLD_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_DBGCTRL_Type): USART3_DBGCTRL_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_DBGCTRL_Fields](reg.loc))

proc write*(reg: USART3_DBGCTRL_Type, val: USART3_DBGCTRL_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_DBGCTRL_Fields](reg.loc), val)

proc write*(reg: USART3_DBGCTRL_Type, DBGRUN: bool = false) =
  var x: uint8
  x.setMask((DBGRUN.uint8 shl 0).masked(0 .. 0))
  reg.write x.USART3_DBGCTRL_Fields

template modifyIt*(reg: USART3_DBGCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_EVCTRL_Type): USART3_EVCTRL_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_EVCTRL_Fields](reg.loc))

proc write*(reg: USART3_EVCTRL_Type, val: USART3_EVCTRL_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_EVCTRL_Fields](reg.loc), val)

proc write*(reg: USART3_EVCTRL_Type, IREI: bool = false) =
  var x: uint8
  x.setMask((IREI.uint8 shl 0).masked(0 .. 0))
  reg.write x.USART3_EVCTRL_Fields

template modifyIt*(reg: USART3_EVCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_RXDATAH_Type): USART3_RXDATAH_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_RXDATAH_Fields](reg.loc))

proc read*(reg: USART3_RXDATAL_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc read*(reg: USART3_RXPLCTRL_Type): USART3_RXPLCTRL_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_RXPLCTRL_Fields](reg.loc))

proc write*(reg: USART3_RXPLCTRL_Type, val: USART3_RXPLCTRL_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_RXPLCTRL_Fields](reg.loc), val)

proc write*(reg: USART3_RXPLCTRL_Type, RXPL: uint8 = 0) =
  var x: uint8
  x.setMask((RXPL shl 0).masked(0 .. 6))
  reg.write x.USART3_RXPLCTRL_Fields

template modifyIt*(reg: USART3_RXPLCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_STATUS_Type): USART3_STATUS_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_STATUS_Fields](reg.loc))

proc write*(reg: USART3_STATUS_Type, val: USART3_STATUS_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_STATUS_Fields](reg.loc), val)

proc write*(reg: USART3_STATUS_Type, WFB: bool = false, BDF: bool = false, ISFIF: bool = false, TXCIF: bool = false) =
  var x: uint8
  x.setMask((WFB.uint8 shl 0).masked(0 .. 0))
  x.setMask((BDF.uint8 shl 1).masked(1 .. 1))
  x.setMask((ISFIF.uint8 shl 3).masked(3 .. 3))
  x.setMask((TXCIF.uint8 shl 6).masked(6 .. 6))
  reg.write x.USART3_STATUS_Fields

template modifyIt*(reg: USART3_STATUS_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_TXDATAH_Type): USART3_TXDATAH_Fields {.inline.} =
  volatileLoad(cast[ptr USART3_TXDATAH_Fields](reg.loc))

proc write*(reg: USART3_TXDATAH_Type, val: USART3_TXDATAH_Fields) {.inline.} =
  volatileStore(cast[ptr USART3_TXDATAH_Fields](reg.loc), val)

proc write*(reg: USART3_TXDATAH_Type, DATA8: bool = false) =
  var x: uint8
  x.setMask((DATA8.uint8 shl 0).masked(0 .. 0))
  reg.write x.USART3_TXDATAH_Fields

template modifyIt*(reg: USART3_TXDATAH_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_TXDATAL_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USART3_TXDATAL_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USART3_TXDATAL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USART3_TXPLCTRL_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USART3_TXPLCTRL_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USART3_TXPLCTRL_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

func RS485*(r: USART3_CTRLA_Fields): UncheckedEnum[USART3_CTRLA_RS485] {.inline.} =
  toUncheckedEnum[USART3_CTRLA_RS485](r.uint8.bitsliced(0 .. 1).int)

proc `RS485=`*(r: var USART3_CTRLA_Fields, val: USART3_CTRLA_RS485) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 1)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 1))
  r = tmp.USART3_CTRLA_Fields

func ABEIE*(r: USART3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `ABEIE=`*(r: var USART3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USART3_CTRLA_Fields

func LBME*(r: USART3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `LBME=`*(r: var USART3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USART3_CTRLA_Fields

func RXSIE*(r: USART3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `RXSIE=`*(r: var USART3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USART3_CTRLA_Fields

func DREIE*(r: USART3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `DREIE=`*(r: var USART3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USART3_CTRLA_Fields

func TXCIE*(r: USART3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `TXCIE=`*(r: var USART3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USART3_CTRLA_Fields

func RXCIE*(r: USART3_CTRLA_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `RXCIE=`*(r: var USART3_CTRLA_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.USART3_CTRLA_Fields

func MPCM*(r: USART3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `MPCM=`*(r: var USART3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USART3_CTRLB_Fields

func RXMODE*(r: USART3_CTRLB_Fields): UncheckedEnum[USART3_CTRLB_RXMODE] {.inline.} =
  toUncheckedEnum[USART3_CTRLB_RXMODE](r.uint8.bitsliced(1 .. 2).int)

proc `RXMODE=`*(r: var USART3_CTRLB_Fields, val: USART3_CTRLB_RXMODE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 2)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 2))
  r = tmp.USART3_CTRLB_Fields

func ODME*(r: USART3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `ODME=`*(r: var USART3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USART3_CTRLB_Fields

func SFDEN*(r: USART3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SFDEN=`*(r: var USART3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USART3_CTRLB_Fields

func TXEN*(r: USART3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `TXEN=`*(r: var USART3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USART3_CTRLB_Fields

func RXEN*(r: USART3_CTRLB_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `RXEN=`*(r: var USART3_CTRLB_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.USART3_CTRLB_Fields

func CHSIZE*(r: USART3_CTRLC_Fields): UncheckedEnum[USART3_CTRLC_CHSIZE] {.inline.} =
  toUncheckedEnum[USART3_CTRLC_CHSIZE](r.uint8.bitsliced(0 .. 2).int)

proc `CHSIZE=`*(r: var USART3_CTRLC_Fields, val: USART3_CTRLC_CHSIZE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 2)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 2))
  r = tmp.USART3_CTRLC_Fields

func UCPHA*(r: USART3_CTRLC_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `UCPHA=`*(r: var USART3_CTRLC_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USART3_CTRLC_Fields

func UDORD*(r: USART3_CTRLC_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `UDORD=`*(r: var USART3_CTRLC_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USART3_CTRLC_Fields

func SBMODE*(r: USART3_CTRLC_Fields): UncheckedEnum[USART3_CTRLC_SBMODE] {.inline.} =
  toUncheckedEnum[USART3_CTRLC_SBMODE](r.uint8.bitsliced(3 .. 3).int)

proc `SBMODE=`*(r: var USART3_CTRLC_Fields, val: USART3_CTRLC_SBMODE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USART3_CTRLC_Fields

func PMODE*(r: USART3_CTRLC_Fields): UncheckedEnum[USART3_CTRLC_PMODE] {.inline.} =
  toUncheckedEnum[USART3_CTRLC_PMODE](r.uint8.bitsliced(4 .. 5).int)

proc `PMODE=`*(r: var USART3_CTRLC_Fields, val: USART3_CTRLC_PMODE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 5)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 5))
  r = tmp.USART3_CTRLC_Fields

func CMODE*(r: USART3_CTRLC_Fields): UncheckedEnum[USART3_CTRLC_CMODE] {.inline.} =
  toUncheckedEnum[USART3_CTRLC_CMODE](r.uint8.bitsliced(6 .. 7).int)

proc `CMODE=`*(r: var USART3_CTRLC_Fields, val: USART3_CTRLC_CMODE) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 7)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 7))
  r = tmp.USART3_CTRLC_Fields

func ABW*(r: USART3_CTRLD_Fields): UncheckedEnum[USART3_CTRLD_ABW] {.inline.} =
  toUncheckedEnum[USART3_CTRLD_ABW](r.uint8.bitsliced(6 .. 7).int)

proc `ABW=`*(r: var USART3_CTRLD_Fields, val: USART3_CTRLD_ABW) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 7)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 7))
  r = tmp.USART3_CTRLD_Fields

func DBGRUN*(r: USART3_DBGCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `DBGRUN=`*(r: var USART3_DBGCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USART3_DBGCTRL_Fields

func IREI*(r: USART3_EVCTRL_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `IREI=`*(r: var USART3_EVCTRL_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USART3_EVCTRL_Fields

func DATA8*(r: USART3_RXDATAH_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

func PERR*(r: USART3_RXDATAH_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

func FERR*(r: USART3_RXDATAH_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

func BUFOVF*(r: USART3_RXDATAH_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

func RXCIF*(r: USART3_RXDATAH_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

func RXPL*(r: USART3_RXPLCTRL_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(0 .. 6)

proc `RXPL=`*(r: var USART3_RXPLCTRL_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 6)
  tmp.setMask((val shl 0).masked(0 .. 6))
  r = tmp.USART3_RXPLCTRL_Fields

func WFB*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `WFB=`*(r: var USART3_STATUS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USART3_STATUS_Fields

func BDF*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `BDF=`*(r: var USART3_STATUS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USART3_STATUS_Fields

func ISFIF*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `ISFIF=`*(r: var USART3_STATUS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USART3_STATUS_Fields

func RXSIF*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

func DREIF*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

func TXCIF*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `TXCIF=`*(r: var USART3_STATUS_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USART3_STATUS_Fields

func RXCIF*(r: USART3_STATUS_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

func DATA8*(r: USART3_TXDATAH_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `DATA8=`*(r: var USART3_TXDATAH_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USART3_TXDATAH_Fields
