# Peripheral access API for ATMEGA168P microcontrollers (generated using svd2nim)
...
proc write*(reg: CPU_SPMCSR_Type, SELFPRGEN: bool = false, PGERS: bool = false, PGWRT: bool = false, BLBSET: bool = false, RWWSRE: bool = false, SIGRD: bool = false, RWWSB: bool = false, SPMIE: bool = false) =
  var x: uint8
