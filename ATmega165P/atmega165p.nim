# Peripheral access API for ATMEGA165P microcontrollers (generated using svd2nim)
...
proc write*(reg: EXINT_EIFR_Type, INTF0: bool = false, PCIF: uint8 = 0) =
  ...
  x.setMask((PCIF shl 6).masked(6 .. 7))
...
proc write*(reg: EXINT_EIMSK_Type, INT0: bool = false, PCIE: uint8 = 0) =
  ...
  x.setMask((PCIE shl 6).masked(6 .. 7))
