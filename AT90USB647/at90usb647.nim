# Peripheral access API for AT90USB647 microcontrollers (generated using svd2nim)
...
type USB_GLOBAL_OTGCON_Type* = object
  loc: uint

type USB_GLOBAL_OTGIEN_Type* = object
  loc: uint

type USB_GLOBAL_OTGINT_Type* = object
  loc: uint

type USB_GLOBAL_OTGTCON_Type* = object
  loc: uint
...
type USB_GLOBAL_Type* = object
  ...
  OTGCON*: USB_GLOBAL_OTGCON_Type
  OTGIEN*: USB_GLOBAL_OTGIEN_Type
  OTGINT*: USB_GLOBAL_OTGINT_Type
  OTGTCON*: USB_GLOBAL_OTGTCON_Type

type USB_HOST_UHADDR_Type* = object
  loc: uint

type USB_HOST_UHCON_Type* = object
  loc: uint

type USB_HOST_UHFLEN_Type* = object
  loc: uint

type USB_HOST_UHFNUM_Type* = object
  loc: uint

type USB_HOST_UHIEN_Type* = object
  loc: uint

type USB_HOST_UHINT_Type* = object
  loc: uint

type USB_HOST_UPBCHX_Type* = object
  loc: uint

type USB_HOST_UPBCLX_Type* = object
  loc: uint

type USB_HOST_UPCFG0X_Type* = object
  loc: uint

type USB_HOST_UPCFG1X_Type* = object
  loc: uint

type USB_HOST_UPCFG2X_Type* = object
  loc: uint

type USB_HOST_UPCONX_Type* = object
  loc: uint

type USB_HOST_UPDATX_Type* = object
  loc: uint

type USB_HOST_UPERRX_Type* = object
  loc: uint

type USB_HOST_UPIENX_Type* = object
  loc: uint

type USB_HOST_UPINRQX_Type* = object
  loc: uint

type USB_HOST_UPINT_Type* = object
  loc: uint

type USB_HOST_UPINTX_Type* = object
  loc: uint

type USB_HOST_UPNUM_Type* = object
  loc: uint

type USB_HOST_UPRST_Type* = object
  loc: uint

type USB_HOST_UPSTAX_Type* = object
  loc: uint

type USB_HOST_Type* = object
  UHCON*: USB_HOST_UHCON_Type
  UHINT*: USB_HOST_UHINT_Type
  UHIEN*: USB_HOST_UHIEN_Type
  UHADDR*: USB_HOST_UHADDR_Type
  UHFNUM*: USB_HOST_UHFNUM_Type
  UHFLEN*: USB_HOST_UHFLEN_Type
  UPINRQX*: USB_HOST_UPINRQX_Type
  UPINTX*: USB_HOST_UPINTX_Type
  UPNUM*: USB_HOST_UPNUM_Type
  UPRST*: USB_HOST_UPRST_Type
  UPCONX*: USB_HOST_UPCONX_Type
  UPCFG0X*: USB_HOST_UPCFG0X_Type
  UPCFG1X*: USB_HOST_UPCFG1X_Type
  UPSTAX*: USB_HOST_UPSTAX_Type
  UPCFG2X*: USB_HOST_UPCFG2X_Type
  UPIENX*: USB_HOST_UPIENX_Type
  UPDATX*: USB_HOST_UPDATX_Type
  UPERRX*: USB_HOST_UPERRX_Type
  UPBCLX*: USB_HOST_UPBCLX_Type
  UPBCHX*: USB_HOST_UPBCHX_Type
  UPINT*: USB_HOST_UPINT_Type
...
const USB_GLOBAL* = USB_GLOBAL_Type(
  ...
  OTGCON: USB_GLOBAL_OTGCON_Type(loc: 0xdd'u),
  OTGIEN: USB_GLOBAL_OTGIEN_Type(loc: 0xde'u),
  OTGINT: USB_GLOBAL_OTGINT_Type(loc: 0xdf'u),
  OTGTCON: USB_GLOBAL_OTGTCON_Type(loc: 0xf9'u),
)

const USB_HOST* = USB_HOST_Type(
  UHCON: USB_HOST_UHCON_Type(loc: 0x9e'u),
  UHINT: USB_HOST_UHINT_Type(loc: 0x9f'u),
  UHIEN: USB_HOST_UHIEN_Type(loc: 0xa0'u),
  UHADDR: USB_HOST_UHADDR_Type(loc: 0xa1'u),
  UHFNUM: USB_HOST_UHFNUM_Type(loc: 0xa2'u),
  UHFLEN: USB_HOST_UHFLEN_Type(loc: 0xa4'u),
  UPINRQX: USB_HOST_UPINRQX_Type(loc: 0xa5'u),
  UPINTX: USB_HOST_UPINTX_Type(loc: 0xa6'u),
  UPNUM: USB_HOST_UPNUM_Type(loc: 0xa7'u),
  UPRST: USB_HOST_UPRST_Type(loc: 0xa8'u),
  UPCONX: USB_HOST_UPCONX_Type(loc: 0xa9'u),
  UPCFG0X: USB_HOST_UPCFG0X_Type(loc: 0xaa'u),
  UPCFG1X: USB_HOST_UPCFG1X_Type(loc: 0xab'u),
  UPSTAX: USB_HOST_UPSTAX_Type(loc: 0xac'u),
  UPCFG2X: USB_HOST_UPCFG2X_Type(loc: 0xad'u),
  UPIENX: USB_HOST_UPIENX_Type(loc: 0xae'u),
  UPDATX: USB_HOST_UPDATX_Type(loc: 0xaf'u),
  UPERRX: USB_HOST_UPERRX_Type(loc: 0xf5'u),
  UPBCLX: USB_HOST_UPBCLX_Type(loc: 0xf6'u),
  UPBCHX: USB_HOST_UPBCHX_Type(loc: 0xf7'u),
  UPINT: USB_HOST_UPINT_Type(loc: 0xf8'u),
)
...
proc write*(reg: FUSE_HIGH_Type, BOOTRST: bool = false, BOOTSZ: FUSE_HIGH_BOOTSZ = x4096W_7800, EESAVE: bool = false, WDTON: bool = false, SPIEN: bool = false, JTAGEN: bool = false, OCDEN: bool = false) =
  var x: uint8
...
type
  USB_GLOBAL_OTGCON_Fields* = distinct uint8
  USB_GLOBAL_OTGIEN_Fields* = distinct uint8
  USB_GLOBAL_OTGINT_Fields* = distinct uint8
  USB_GLOBAL_OTGTCON_Fields* = distinct uint8
...
proc read*(reg: USB_GLOBAL_OTGCON_Type): USB_GLOBAL_OTGCON_Fields {.inline.} =
  volatileLoad(cast[ptr USB_GLOBAL_OTGCON_Fields](reg.loc))

proc write*(reg: USB_GLOBAL_OTGCON_Type, val: USB_GLOBAL_OTGCON_Fields) {.inline.} =
  volatileStore(cast[ptr USB_GLOBAL_OTGCON_Fields](reg.loc), val)

proc write*(reg: USB_GLOBAL_OTGCON_Type, VBUSRQC: bool = false, VBUSREQ: bool = false, VBUSHWC: bool = false, SRPSEL: bool = false, SRPREQ: bool = false, HNPREQ: bool = false) =
  var x: uint8
  x.setMask((VBUSRQC.uint8 shl 0).masked(0 .. 0))
  x.setMask((VBUSREQ.uint8 shl 1).masked(1 .. 1))
  x.setMask((VBUSHWC.uint8 shl 2).masked(2 .. 2))
  x.setMask((SRPSEL.uint8 shl 3).masked(3 .. 3))
  x.setMask((SRPREQ.uint8 shl 4).masked(4 .. 4))
  x.setMask((HNPREQ.uint8 shl 5).masked(5 .. 5))
  reg.write x.USB_GLOBAL_OTGCON_Fields

template modifyIt*(reg: USB_GLOBAL_OTGCON_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_GLOBAL_OTGIEN_Type): USB_GLOBAL_OTGIEN_Fields {.inline.} =
  volatileLoad(cast[ptr USB_GLOBAL_OTGIEN_Fields](reg.loc))

proc write*(reg: USB_GLOBAL_OTGIEN_Type, val: USB_GLOBAL_OTGIEN_Fields) {.inline.} =
  volatileStore(cast[ptr USB_GLOBAL_OTGIEN_Fields](reg.loc), val)

proc write*(reg: USB_GLOBAL_OTGIEN_Type, SRPE: bool = false, VBERRE: bool = false, BCERRE: bool = false, ROLEEXE: bool = false, HNPERRE: bool = false, STOE: bool = false) =
  var x: uint8
  x.setMask((SRPE.uint8 shl 0).masked(0 .. 0))
  x.setMask((VBERRE.uint8 shl 1).masked(1 .. 1))
  x.setMask((BCERRE.uint8 shl 2).masked(2 .. 2))
  x.setMask((ROLEEXE.uint8 shl 3).masked(3 .. 3))
  x.setMask((HNPERRE.uint8 shl 4).masked(4 .. 4))
  x.setMask((STOE.uint8 shl 5).masked(5 .. 5))
  reg.write x.USB_GLOBAL_OTGIEN_Fields

template modifyIt*(reg: USB_GLOBAL_OTGIEN_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_GLOBAL_OTGINT_Type): USB_GLOBAL_OTGINT_Fields {.inline.} =
  volatileLoad(cast[ptr USB_GLOBAL_OTGINT_Fields](reg.loc))

proc write*(reg: USB_GLOBAL_OTGINT_Type, val: USB_GLOBAL_OTGINT_Fields) {.inline.} =
  volatileStore(cast[ptr USB_GLOBAL_OTGINT_Fields](reg.loc), val)

proc write*(reg: USB_GLOBAL_OTGINT_Type, SRPI: bool = false, VBERRI: bool = false, BCERRI: bool = false, ROLEEXI: bool = false, HNPERRI: bool = false, STOI: bool = false) =
  var x: uint8
  x.setMask((SRPI.uint8 shl 0).masked(0 .. 0))
  x.setMask((VBERRI.uint8 shl 1).masked(1 .. 1))
  x.setMask((BCERRI.uint8 shl 2).masked(2 .. 2))
  x.setMask((ROLEEXI.uint8 shl 3).masked(3 .. 3))
  x.setMask((HNPERRI.uint8 shl 4).masked(4 .. 4))
  x.setMask((STOI.uint8 shl 5).masked(5 .. 5))
  reg.write x.USB_GLOBAL_OTGINT_Fields

template modifyIt*(reg: USB_GLOBAL_OTGINT_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_GLOBAL_OTGTCON_Type): USB_GLOBAL_OTGTCON_Fields {.inline.} =
  volatileLoad(cast[ptr USB_GLOBAL_OTGTCON_Fields](reg.loc))

proc write*(reg: USB_GLOBAL_OTGTCON_Type, val: USB_GLOBAL_OTGTCON_Fields) {.inline.} =
  volatileStore(cast[ptr USB_GLOBAL_OTGTCON_Fields](reg.loc), val)

proc write*(reg: USB_GLOBAL_OTGTCON_Type, VALUE_2: uint8 = 0, PAGE: uint8 = 0, OTGTCON_7: bool = false) =
  var x: uint8
  x.setMask((VALUE_2 shl 0).masked(0 .. 2))
  x.setMask((PAGE shl 5).masked(5 .. 6))
  x.setMask((OTGTCON_7.uint8 shl 7).masked(7 .. 7))
  reg.write x.USB_GLOBAL_OTGTCON_Fields

template modifyIt*(reg: USB_GLOBAL_OTGTCON_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)
...
func VBUSRQC*(r: USB_GLOBAL_OTGCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `VBUSRQC=`*(r: var USB_GLOBAL_OTGCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_GLOBAL_OTGCON_Fields

func VBUSREQ*(r: USB_GLOBAL_OTGCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `VBUSREQ=`*(r: var USB_GLOBAL_OTGCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_GLOBAL_OTGCON_Fields

func VBUSHWC*(r: USB_GLOBAL_OTGCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `VBUSHWC=`*(r: var USB_GLOBAL_OTGCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_GLOBAL_OTGCON_Fields

func SRPSEL*(r: USB_GLOBAL_OTGCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SRPSEL=`*(r: var USB_GLOBAL_OTGCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_GLOBAL_OTGCON_Fields

func SRPREQ*(r: USB_GLOBAL_OTGCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SRPREQ=`*(r: var USB_GLOBAL_OTGCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_GLOBAL_OTGCON_Fields

func HNPREQ*(r: USB_GLOBAL_OTGCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `HNPREQ=`*(r: var USB_GLOBAL_OTGCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_GLOBAL_OTGCON_Fields

func SRPE*(r: USB_GLOBAL_OTGIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SRPE=`*(r: var USB_GLOBAL_OTGIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_GLOBAL_OTGIEN_Fields

func VBERRE*(r: USB_GLOBAL_OTGIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `VBERRE=`*(r: var USB_GLOBAL_OTGIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_GLOBAL_OTGIEN_Fields

func BCERRE*(r: USB_GLOBAL_OTGIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `BCERRE=`*(r: var USB_GLOBAL_OTGIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_GLOBAL_OTGIEN_Fields

func ROLEEXE*(r: USB_GLOBAL_OTGIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `ROLEEXE=`*(r: var USB_GLOBAL_OTGIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_GLOBAL_OTGIEN_Fields

func HNPERRE*(r: USB_GLOBAL_OTGIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `HNPERRE=`*(r: var USB_GLOBAL_OTGIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_GLOBAL_OTGIEN_Fields

func STOE*(r: USB_GLOBAL_OTGIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `STOE=`*(r: var USB_GLOBAL_OTGIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_GLOBAL_OTGIEN_Fields

func SRPI*(r: USB_GLOBAL_OTGINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SRPI=`*(r: var USB_GLOBAL_OTGINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_GLOBAL_OTGINT_Fields

func VBERRI*(r: USB_GLOBAL_OTGINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `VBERRI=`*(r: var USB_GLOBAL_OTGINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_GLOBAL_OTGINT_Fields

func BCERRI*(r: USB_GLOBAL_OTGINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `BCERRI=`*(r: var USB_GLOBAL_OTGINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_GLOBAL_OTGINT_Fields

func ROLEEXI*(r: USB_GLOBAL_OTGINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `ROLEEXI=`*(r: var USB_GLOBAL_OTGINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_GLOBAL_OTGINT_Fields

func HNPERRI*(r: USB_GLOBAL_OTGINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `HNPERRI=`*(r: var USB_GLOBAL_OTGINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_GLOBAL_OTGINT_Fields

func STOI*(r: USB_GLOBAL_OTGINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `STOI=`*(r: var USB_GLOBAL_OTGINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_GLOBAL_OTGINT_Fields

func VALUE_2*(r: USB_GLOBAL_OTGTCON_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(0 .. 2)

proc `VALUE_2=`*(r: var USB_GLOBAL_OTGTCON_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 2)
  tmp.setMask((val shl 0).masked(0 .. 2))
  r = tmp.USB_GLOBAL_OTGTCON_Fields

func PAGE*(r: USB_GLOBAL_OTGTCON_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(5 .. 6)

proc `PAGE=`*(r: var USB_GLOBAL_OTGTCON_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 6)
  tmp.setMask((val shl 5).masked(5 .. 6))
  r = tmp.USB_GLOBAL_OTGTCON_Fields

func OTGTCON_7*(r: USB_GLOBAL_OTGTCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `OTGTCON_7=`*(r: var USB_GLOBAL_OTGTCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.USB_GLOBAL_OTGTCON_Fields
...
type
  USB_HOST_UHCON_Fields* = distinct uint8
  USB_HOST_UHIEN_Fields* = distinct uint8
  USB_HOST_UHINT_Fields* = distinct uint8
  USB_HOST_UPCFG0X_Fields* = distinct uint8
  USB_HOST_UPCFG1X_Fields* = distinct uint8
  USB_HOST_UPCONX_Fields* = distinct uint8
  USB_HOST_UPERRX_Fields* = distinct uint8
  USB_HOST_UPIENX_Fields* = distinct uint8
  USB_HOST_UPINTX_Fields* = distinct uint8
  USB_HOST_UPRST_Fields* = distinct uint8
  USB_HOST_UPSTAX_Fields* = distinct uint8

proc read*(reg: USB_HOST_UHADDR_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UHADDR_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UHADDR_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UHCON_Type): USB_HOST_UHCON_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UHCON_Fields](reg.loc))

proc write*(reg: USB_HOST_UHCON_Type, val: USB_HOST_UHCON_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UHCON_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UHCON_Type, SOFEN: bool = false, RESET: bool = false, RESUME: bool = false) =
  var x: uint8
  x.setMask((SOFEN.uint8 shl 0).masked(0 .. 0))
  x.setMask((RESET.uint8 shl 1).masked(1 .. 1))
  x.setMask((RESUME.uint8 shl 2).masked(2 .. 2))
  reg.write x.USB_HOST_UHCON_Fields

template modifyIt*(reg: USB_HOST_UHCON_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UHFLEN_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UHFLEN_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UHFLEN_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UHFNUM_Type): uint16 {.inline.} =
  volatileLoad(cast[ptr uint16](reg.loc))

proc write*(reg: USB_HOST_UHFNUM_Type, val: uint16) {.inline.} =
  volatileStore(cast[ptr uint16](reg.loc), val)

template modifyIt*(reg: USB_HOST_UHFNUM_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UHIEN_Type): USB_HOST_UHIEN_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UHIEN_Fields](reg.loc))

proc write*(reg: USB_HOST_UHIEN_Type, val: USB_HOST_UHIEN_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UHIEN_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UHIEN_Type, DCONNE: bool = false, DDISCE: bool = false, RSTE: bool = false, RSMEDE: bool = false, RXRSME: bool = false, HSOFE: bool = false, HWUPE: bool = false) =
  var x: uint8
  x.setMask((DCONNE.uint8 shl 0).masked(0 .. 0))
  x.setMask((DDISCE.uint8 shl 1).masked(1 .. 1))
  x.setMask((RSTE.uint8 shl 2).masked(2 .. 2))
  x.setMask((RSMEDE.uint8 shl 3).masked(3 .. 3))
  x.setMask((RXRSME.uint8 shl 4).masked(4 .. 4))
  x.setMask((HSOFE.uint8 shl 5).masked(5 .. 5))
  x.setMask((HWUPE.uint8 shl 6).masked(6 .. 6))
  reg.write x.USB_HOST_UHIEN_Fields

template modifyIt*(reg: USB_HOST_UHIEN_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UHINT_Type): USB_HOST_UHINT_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UHINT_Fields](reg.loc))

proc write*(reg: USB_HOST_UHINT_Type, val: USB_HOST_UHINT_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UHINT_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UHINT_Type, DCONNI: bool = false, DDISCI: bool = false, RSTI: bool = false, RSMEDI: bool = false, RXRSMI: bool = false, HSOFI: bool = false, UHUPI: bool = false) =
  var x: uint8
  x.setMask((DCONNI.uint8 shl 0).masked(0 .. 0))
  x.setMask((DDISCI.uint8 shl 1).masked(1 .. 1))
  x.setMask((RSTI.uint8 shl 2).masked(2 .. 2))
  x.setMask((RSMEDI.uint8 shl 3).masked(3 .. 3))
  x.setMask((RXRSMI.uint8 shl 4).masked(4 .. 4))
  x.setMask((HSOFI.uint8 shl 5).masked(5 .. 5))
  x.setMask((UHUPI.uint8 shl 6).masked(6 .. 6))
  reg.write x.USB_HOST_UHINT_Fields

template modifyIt*(reg: USB_HOST_UHINT_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPBCHX_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPBCHX_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPBCHX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPBCLX_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPBCLX_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPBCLX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPCFG0X_Type): USB_HOST_UPCFG0X_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPCFG0X_Fields](reg.loc))

proc write*(reg: USB_HOST_UPCFG0X_Type, val: USB_HOST_UPCFG0X_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPCFG0X_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPCFG0X_Type, PEPNUM: uint8 = 0, PTOKEN: uint8 = 0, PTYPE: uint8 = 0) =
  var x: uint8
  x.setMask((PEPNUM shl 0).masked(0 .. 3))
  x.setMask((PTOKEN shl 4).masked(4 .. 5))
  x.setMask((PTYPE shl 6).masked(6 .. 7))
  reg.write x.USB_HOST_UPCFG0X_Fields

template modifyIt*(reg: USB_HOST_UPCFG0X_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPCFG1X_Type): USB_HOST_UPCFG1X_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPCFG1X_Fields](reg.loc))

proc write*(reg: USB_HOST_UPCFG1X_Type, val: USB_HOST_UPCFG1X_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPCFG1X_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPCFG1X_Type, ALLOC: bool = false, PBK: uint8 = 0, PSIZE: uint8 = 0) =
  var x: uint8
  x.setMask((ALLOC.uint8 shl 1).masked(1 .. 1))
  x.setMask((PBK shl 2).masked(2 .. 3))
  x.setMask((PSIZE shl 4).masked(4 .. 6))
  reg.write x.USB_HOST_UPCFG1X_Fields

template modifyIt*(reg: USB_HOST_UPCFG1X_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPCFG2X_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPCFG2X_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPCFG2X_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPCONX_Type): USB_HOST_UPCONX_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPCONX_Fields](reg.loc))

proc write*(reg: USB_HOST_UPCONX_Type, val: USB_HOST_UPCONX_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPCONX_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPCONX_Type, PEN: bool = false, RSTDT: bool = false, INMODE: bool = false, PFREEZE: bool = false) =
  var x: uint8
  x.setMask((PEN.uint8 shl 0).masked(0 .. 0))
  x.setMask((RSTDT.uint8 shl 3).masked(3 .. 3))
  x.setMask((INMODE.uint8 shl 5).masked(5 .. 5))
  x.setMask((PFREEZE.uint8 shl 6).masked(6 .. 6))
  reg.write x.USB_HOST_UPCONX_Fields

template modifyIt*(reg: USB_HOST_UPCONX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPDATX_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPDATX_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPDATX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPERRX_Type): USB_HOST_UPERRX_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPERRX_Fields](reg.loc))

proc write*(reg: USB_HOST_UPERRX_Type, val: USB_HOST_UPERRX_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPERRX_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPERRX_Type, DATATGL: bool = false, DATAPID: bool = false, PID: bool = false, TIMEOUT: bool = false, CRC16: bool = false, COUNTER: uint8 = 0) =
  var x: uint8
  x.setMask((DATATGL.uint8 shl 0).masked(0 .. 0))
  x.setMask((DATAPID.uint8 shl 1).masked(1 .. 1))
  x.setMask((PID.uint8 shl 2).masked(2 .. 2))
  x.setMask((TIMEOUT.uint8 shl 3).masked(3 .. 3))
  x.setMask((CRC16.uint8 shl 4).masked(4 .. 4))
  x.setMask((COUNTER shl 5).masked(5 .. 6))
  reg.write x.USB_HOST_UPERRX_Fields

template modifyIt*(reg: USB_HOST_UPERRX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPIENX_Type): USB_HOST_UPIENX_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPIENX_Fields](reg.loc))

proc write*(reg: USB_HOST_UPIENX_Type, val: USB_HOST_UPIENX_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPIENX_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPIENX_Type, RXINE: bool = false, RXSTALLE: bool = false, TXOUTE: bool = false, TXSTPE: bool = false, PERRE: bool = false, NAKEDE: bool = false, FLERRE: bool = false) =
  var x: uint8
  x.setMask((RXINE.uint8 shl 0).masked(0 .. 0))
  x.setMask((RXSTALLE.uint8 shl 1).masked(1 .. 1))
  x.setMask((TXOUTE.uint8 shl 2).masked(2 .. 2))
  x.setMask((TXSTPE.uint8 shl 3).masked(3 .. 3))
  x.setMask((PERRE.uint8 shl 4).masked(4 .. 4))
  x.setMask((NAKEDE.uint8 shl 6).masked(6 .. 6))
  x.setMask((FLERRE.uint8 shl 7).masked(7 .. 7))
  reg.write x.USB_HOST_UPIENX_Fields

template modifyIt*(reg: USB_HOST_UPIENX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPINRQX_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPINRQX_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPINRQX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPINT_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPINT_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPINT_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPINTX_Type): USB_HOST_UPINTX_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPINTX_Fields](reg.loc))

proc write*(reg: USB_HOST_UPINTX_Type, val: USB_HOST_UPINTX_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPINTX_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPINTX_Type, RXINI: bool = false, RXSTALLI: bool = false, TXOUTI: bool = false, TXSTPI: bool = false, PERRI: bool = false, RWAL: bool = false, NAKEDI: bool = false, FIFOCON: bool = false) =
  var x: uint8
  x.setMask((RXINI.uint8 shl 0).masked(0 .. 0))
  x.setMask((RXSTALLI.uint8 shl 1).masked(1 .. 1))
  x.setMask((TXOUTI.uint8 shl 2).masked(2 .. 2))
  x.setMask((TXSTPI.uint8 shl 3).masked(3 .. 3))
  x.setMask((PERRI.uint8 shl 4).masked(4 .. 4))
  x.setMask((RWAL.uint8 shl 5).masked(5 .. 5))
  x.setMask((NAKEDI.uint8 shl 6).masked(6 .. 6))
  x.setMask((FIFOCON.uint8 shl 7).masked(7 .. 7))
  reg.write x.USB_HOST_UPINTX_Fields

template modifyIt*(reg: USB_HOST_UPINTX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPNUM_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: USB_HOST_UPNUM_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)

template modifyIt*(reg: USB_HOST_UPNUM_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPRST_Type): USB_HOST_UPRST_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPRST_Fields](reg.loc))

proc write*(reg: USB_HOST_UPRST_Type, val: USB_HOST_UPRST_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPRST_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPRST_Type, PRST: uint8 = 0) =
  var x: uint8
  x.setMask((PRST shl 0).masked(0 .. 6))
  reg.write x.USB_HOST_UPRST_Fields

template modifyIt*(reg: USB_HOST_UPRST_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

proc read*(reg: USB_HOST_UPSTAX_Type): USB_HOST_UPSTAX_Fields {.inline.} =
  volatileLoad(cast[ptr USB_HOST_UPSTAX_Fields](reg.loc))

proc write*(reg: USB_HOST_UPSTAX_Type, val: USB_HOST_UPSTAX_Fields) {.inline.} =
  volatileStore(cast[ptr USB_HOST_UPSTAX_Fields](reg.loc), val)

proc write*(reg: USB_HOST_UPSTAX_Type, NBUSYK: uint8 = 0, DTSEQ: uint8 = 0, UNDERFI: bool = false, OVERFI: bool = false, CFGOK: bool = false) =
  var x: uint8
  x.setMask((NBUSYK shl 0).masked(0 .. 1))
  x.setMask((DTSEQ shl 2).masked(2 .. 3))
  x.setMask((UNDERFI.uint8 shl 5).masked(5 .. 5))
  x.setMask((OVERFI.uint8 shl 6).masked(6 .. 6))
  x.setMask((CFGOK.uint8 shl 7).masked(7 .. 7))
  reg.write x.USB_HOST_UPSTAX_Fields

template modifyIt*(reg: USB_HOST_UPSTAX_Type, op: untyped): untyped =
  block:
    var it {.inject.} = reg.read()
    op
    reg.write(it)

func SOFEN*(r: USB_HOST_UHCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SOFEN=`*(r: var USB_HOST_UHCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UHCON_Fields

func RESET*(r: USB_HOST_UHCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `RESET=`*(r: var USB_HOST_UHCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UHCON_Fields

func RESUME*(r: USB_HOST_UHCON_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `RESUME=`*(r: var USB_HOST_UHCON_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_HOST_UHCON_Fields

func DCONNE*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `DCONNE=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UHIEN_Fields

func DDISCE*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `DDISCE=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UHIEN_Fields

func RSTE*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `RSTE=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_HOST_UHIEN_Fields

func RSMEDE*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `RSMEDE=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_HOST_UHIEN_Fields

func RXRSME*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `RXRSME=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_HOST_UHIEN_Fields

func HSOFE*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `HSOFE=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_HOST_UHIEN_Fields

func HWUPE*(r: USB_HOST_UHIEN_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `HWUPE=`*(r: var USB_HOST_UHIEN_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USB_HOST_UHIEN_Fields

func DCONNI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `DCONNI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UHINT_Fields

func DDISCI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `DDISCI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UHINT_Fields

func RSTI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `RSTI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_HOST_UHINT_Fields

func RSMEDI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `RSMEDI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_HOST_UHINT_Fields

func RXRSMI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `RXRSMI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_HOST_UHINT_Fields

func HSOFI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `HSOFI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_HOST_UHINT_Fields

func UHUPI*(r: USB_HOST_UHINT_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `UHUPI=`*(r: var USB_HOST_UHINT_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USB_HOST_UHINT_Fields

func PEPNUM*(r: USB_HOST_UPCFG0X_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(0 .. 3)

proc `PEPNUM=`*(r: var USB_HOST_UPCFG0X_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 3)
  tmp.setMask((val shl 0).masked(0 .. 3))
  r = tmp.USB_HOST_UPCFG0X_Fields

func PTOKEN*(r: USB_HOST_UPCFG0X_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(4 .. 5)

proc `PTOKEN=`*(r: var USB_HOST_UPCFG0X_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 5)
  tmp.setMask((val shl 4).masked(4 .. 5))
  r = tmp.USB_HOST_UPCFG0X_Fields

func PTYPE*(r: USB_HOST_UPCFG0X_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(6 .. 7)

proc `PTYPE=`*(r: var USB_HOST_UPCFG0X_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 7)
  tmp.setMask((val shl 6).masked(6 .. 7))
  r = tmp.USB_HOST_UPCFG0X_Fields

func ALLOC*(r: USB_HOST_UPCFG1X_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `ALLOC=`*(r: var USB_HOST_UPCFG1X_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UPCFG1X_Fields

func PBK*(r: USB_HOST_UPCFG1X_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(2 .. 3)

proc `PBK=`*(r: var USB_HOST_UPCFG1X_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 3)
  tmp.setMask((val shl 2).masked(2 .. 3))
  r = tmp.USB_HOST_UPCFG1X_Fields

func PSIZE*(r: USB_HOST_UPCFG1X_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(4 .. 6)

proc `PSIZE=`*(r: var USB_HOST_UPCFG1X_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 6)
  tmp.setMask((val shl 4).masked(4 .. 6))
  r = tmp.USB_HOST_UPCFG1X_Fields

func PEN*(r: USB_HOST_UPCONX_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PEN=`*(r: var USB_HOST_UPCONX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UPCONX_Fields

func RSTDT*(r: USB_HOST_UPCONX_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `RSTDT=`*(r: var USB_HOST_UPCONX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_HOST_UPCONX_Fields

func INMODE*(r: USB_HOST_UPCONX_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `INMODE=`*(r: var USB_HOST_UPCONX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_HOST_UPCONX_Fields

func PFREEZE*(r: USB_HOST_UPCONX_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PFREEZE=`*(r: var USB_HOST_UPCONX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USB_HOST_UPCONX_Fields

func DATATGL*(r: USB_HOST_UPERRX_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `DATATGL=`*(r: var USB_HOST_UPERRX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UPERRX_Fields

func DATAPID*(r: USB_HOST_UPERRX_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `DATAPID=`*(r: var USB_HOST_UPERRX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UPERRX_Fields

func PID*(r: USB_HOST_UPERRX_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PID=`*(r: var USB_HOST_UPERRX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_HOST_UPERRX_Fields

func TIMEOUT*(r: USB_HOST_UPERRX_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `TIMEOUT=`*(r: var USB_HOST_UPERRX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_HOST_UPERRX_Fields

func CRC16*(r: USB_HOST_UPERRX_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `CRC16=`*(r: var USB_HOST_UPERRX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_HOST_UPERRX_Fields

func COUNTER*(r: USB_HOST_UPERRX_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(5 .. 6)

proc `COUNTER=`*(r: var USB_HOST_UPERRX_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 6)
  tmp.setMask((val shl 5).masked(5 .. 6))
  r = tmp.USB_HOST_UPERRX_Fields

func RXINE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `RXINE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UPIENX_Fields

func RXSTALLE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `RXSTALLE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UPIENX_Fields

func TXOUTE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `TXOUTE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_HOST_UPIENX_Fields

func TXSTPE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `TXSTPE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_HOST_UPIENX_Fields

func PERRE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PERRE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_HOST_UPIENX_Fields

func NAKEDE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `NAKEDE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USB_HOST_UPIENX_Fields

func FLERRE*(r: USB_HOST_UPIENX_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `FLERRE=`*(r: var USB_HOST_UPIENX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.USB_HOST_UPIENX_Fields

func RXINI*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `RXINI=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.USB_HOST_UPINTX_Fields

func RXSTALLI*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `RXSTALLI=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.USB_HOST_UPINTX_Fields

func TXOUTI*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `TXOUTI=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.USB_HOST_UPINTX_Fields

func TXSTPI*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `TXSTPI=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.USB_HOST_UPINTX_Fields

func PERRI*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PERRI=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.USB_HOST_UPINTX_Fields

func RWAL*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `RWAL=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_HOST_UPINTX_Fields

func NAKEDI*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `NAKEDI=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USB_HOST_UPINTX_Fields

func FIFOCON*(r: USB_HOST_UPINTX_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `FIFOCON=`*(r: var USB_HOST_UPINTX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.USB_HOST_UPINTX_Fields

func PRST*(r: USB_HOST_UPRST_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(0 .. 6)

proc `PRST=`*(r: var USB_HOST_UPRST_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 6)
  tmp.setMask((val shl 0).masked(0 .. 6))
  r = tmp.USB_HOST_UPRST_Fields

func NBUSYK*(r: USB_HOST_UPSTAX_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(0 .. 1)

proc `NBUSYK=`*(r: var USB_HOST_UPSTAX_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 1)
  tmp.setMask((val shl 0).masked(0 .. 1))
  r = tmp.USB_HOST_UPSTAX_Fields

func DTSEQ*(r: USB_HOST_UPSTAX_Fields): uint8 {.inline.} =
  r.uint8.bitsliced(2 .. 3)

proc `DTSEQ=`*(r: var USB_HOST_UPSTAX_Fields, val: uint8) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 3)
  tmp.setMask((val shl 2).masked(2 .. 3))
  r = tmp.USB_HOST_UPSTAX_Fields

func UNDERFI*(r: USB_HOST_UPSTAX_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `UNDERFI=`*(r: var USB_HOST_UPSTAX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.USB_HOST_UPSTAX_Fields

func OVERFI*(r: USB_HOST_UPSTAX_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `OVERFI=`*(r: var USB_HOST_UPSTAX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.USB_HOST_UPSTAX_Fields

func CFGOK*(r: USB_HOST_UPSTAX_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `CFGOK=`*(r: var USB_HOST_UPSTAX_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.USB_HOST_UPSTAX_Fields
