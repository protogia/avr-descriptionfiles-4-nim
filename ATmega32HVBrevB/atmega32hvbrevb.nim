# Peripheral access API for ATMEGA32HVBREVB microcontrollers (generated using svd2nim)
...
proc write*(reg: FUSE_HIGH_Type, BOOTRST: bool = false, BOOTSZ: FUSE_HIGH_BOOTSZ = x2048W_3800, DWEN: bool = false, DUVRDINIT: bool = false) =
  var x: uint8
