# Peripheral access API for ATMEGA168PB microcontrollers (generated using svd2nim)
...
proc write*(reg: FUSE_EXTENDED_Type, BOOTRST: bool = false, BOOTSZ: FUSE_EXTENDED_BOOTSZ = x1024W_1C00) =
  var x: uint8
