# Peripheral access API for ATMEGA64RFR2 microcontrollers (generated using svd2nim)
...
proc write*(reg: FLASH_BGCR_Type, BGCAL: FLASH_BGCR_BGCAL = SETTING_FOR_HIGHEST_VOLTAGE, BGCAL_FINE: FLASH_BGCR_BGCAL_FINE = CENTER_VALUE) =
  var x: uint8
...
proc write*(reg: PWRCTRL_DRTRAM2_Type, ENDRT: bool = false, DRTSWOK: bool = false) =
  var x: uint8
  x.setMask((ENDRT.uint8 shl 4).masked(4 .. 4))
  x.setMask((DRTSWOK.uint8 shl 5).masked(5 .. 5))
...
proc write*(reg: PWRCTRL_LLCR_Type, LLENCAL: bool = false, LLSHORT: bool = false, LLTCO: bool = false, LLCAL: bool = false, LLCOMP: bool = false, LLDONE: bool = false) =
  var x: uint8
...
proc write*(reg: SYMCNT_SCIRQM_Type, IRQMCP: uint8 = 0, IRQMOF: bool = false, IRQMBO: bool = false) =
  var x: uint8
...
proc write*(reg: SYMCNT_SCIRQS_Type, IRQSCP: uint8 = 0, IRQSOF: bool = false, IRQSBO: bool = false) =
  var x: uint8
...
proc write*(reg: SYMCNT_SCSR_Type, SCBSY: bool = false) =
  var x: uint8
...
proc write*(reg: TC0_TCCR0A_Type, WGM0: TC0_TCCR0A_WGM0 = NORMAL_MODE_OF_OPERATION, COM0B: TC0_TCCR0A_COM0B = NORMAL_PORT_OPERATION_OC0B_DISCONNECTED, COM0A: TC0_TCCR0A_COM0A = NORMAL_PORT_OPERATION_OC0A_DISCONNECTED) =
  var x: uint8
...
proc write*(reg: TC0_TCCR0B_Type, CS0: TC0_TCCR0B_CS0 = NO_CLOCK_SOURCE_TIMER_COUNTER0_STOPPED, WGM02: bool = false, FOC0B: bool = false, FOC0A: bool = false) =
  var x: uint8
...
proc write*(reg: TC1_TCCR1B_Type, CS1: TC1_TCCR1B_CS1 = NO_CLOCK_SOURCE_TIMER_COUNTER_STOPPED, WGM1: TC1_TCCR1B_WGM1 = NORMAL_MODE_OF_OPERATION, ICES1: bool = false, ICNC1: bool = false) =
  var x: uint8
...
proc write*(reg: TC3_TCCR3B_Type, CS3: TC3_TCCR3B_CS3 = NO_CLOCK_SOURCE_TIMER_COUNTER_STOPPED, WGM3: TC3_TCCR3B_WGM3 = NORMAL_MODE_OF_OPERATION, ICES3: bool = false, ICNC3: bool = false) =
  var x: uint8
...
proc write*(reg: TC4_TCCR4B_Type, CS4: TC4_TCCR4B_CS4 = NO_CLOCK_SOURCE_TIMER_COUNTER_STOPPED, WGM4: TC4_TCCR4B_WGM4 = NORMAL_MODE_OF_OPERATION, ICES4: bool = false, ICNC4: bool = false) =
  var x: uint8
...
proc write*(reg: TC5_TCCR5B_Type, CS5: TC5_TCCR5B_CS5 = NO_CLOCK_SOURCE_TIMER_COUNTER_STOPPED, WGM5: TC5_TCCR5B_WGM5 = NORMAL_MODE_OF_OPERATION, ICES5: bool = false, ICNC5: bool = false) =
  var x: uint8
...
proc write*(reg: TRX24_IRQ_MASK1_Type, TX_START_EN: bool = false, MAF_0_AMI_EN: bool = false, MAF_1_AMI_EN: bool = false, MAF_2_AMI_EN: bool = false, MAF_3_AMI_EN: bool = false) =
  var x: uint8
...
proc write*(reg: TRX24_IRQ_STATUS1_Type, TX_START: bool = false, MAF_0_AMI: bool = false, MAF_1_AMI: bool = false, MAF_2_AMI: bool = false, MAF_3_AMI: bool = false) =
  var x: uint8
...
proc write*(reg: TRX24_MAFCR0_Type, MAF0EN: bool = false, MAF1EN: bool = false, MAF2EN: bool = false, MAF3EN: bool = false) =
  var x: uint8
...
proc write*(reg: TWI_TWSR_Type, TWPS: TWI_TWSR_TWPS = x1, TWS: TWI_TWSR_TWS = BUS_ERROR_DUE_TO_ILLEGAL_START_OR_STOP_CONDITION) =
  var x: uint8
