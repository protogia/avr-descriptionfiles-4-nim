# Peripheral access API for ATMEGA128A microcontrollers (generated using svd2nim)
...
proc read*(reg: CPU_XDIV_Type): uint8 {.inline.} =
  volatileLoad(cast[ptr uint8](reg.loc))

proc write*(reg: CPU_XDIV_Type, val: uint8) {.inline.} =
  volatileStore(cast[ptr uint8](reg.loc), val)
