# Peripheral access API for ATMEGA16M1 microcontrollers (generated using svd2nim)
...
proc write*(reg: FUSE_HIGH_Type, BOOTRST: bool = false, BOOTSZ: FUSE_HIGH_BOOTSZ = x2048W_1800, EESAVE: bool = false, WDTON: bool = false, SPIEN: bool = false, DWEN: bool = false, RSTDISBL: bool = false) =
  var x: uint8
...
type
  ...
  PSC_POCR0RA_Fields* = distinct uint16
  PSC_POCR0SA_Fields* = distinct uint16
  PSC_POCR0SB_Fields* = distinct uint16
  PSC_POCR1RA_Fields* = distinct uint16
  PSC_POCR1SA_Fields* = distinct uint16
  PSC_POCR1SB_Fields* = distinct uint16
  PSC_POCR2RA_Fields* = distinct uint16
  PSC_POCR2SA_Fields* = distinct uint16
  PSC_POCR2SB_Fields* = distinct uint16
  PSC_POCR_RB_Fields* = distinct uint16
...
proc read*(reg: PSC_POCR0RA_Type): PSC_POCR0RA_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR0RA_Fields](reg.loc))

proc write*(reg: PSC_POCR0RA_Type, val: PSC_POCR0RA_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR0RA_Fields](reg.loc), val)

proc write*(reg: PSC_POCR0RA_Type, POCR0RA: uint16 = 0) =
  var x: uint16
  x.setMask((POCR0RA shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR0RA_Fields
...
proc read*(reg: PSC_POCR0SA_Type): PSC_POCR0SA_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR0SA_Fields](reg.loc))

proc write*(reg: PSC_POCR0SA_Type, val: PSC_POCR0SA_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR0SA_Fields](reg.loc), val)

proc write*(reg: PSC_POCR0SA_Type, POCR0SA: uint16 = 0) =
  var x: uint16
  x.setMask((POCR0SA shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR0SA_Fields
...
proc read*(reg: PSC_POCR0SB_Type): PSC_POCR0SB_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR0SB_Fields](reg.loc))

proc write*(reg: PSC_POCR0SB_Type, val: PSC_POCR0SB_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR0SB_Fields](reg.loc), val)

proc write*(reg: PSC_POCR0SB_Type, POCR0SB: uint16 = 0) =
  var x: uint16
  x.setMask((POCR0SB shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR0SB_Fields
...
proc read*(reg: PSC_POCR1RA_Type): PSC_POCR1RA_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR1RA_Fields](reg.loc))

proc write*(reg: PSC_POCR1RA_Type, val: PSC_POCR1RA_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR1RA_Fields](reg.loc), val)

proc write*(reg: PSC_POCR1RA_Type, POCR1RA: uint16 = 0) =
  var x: uint16
  x.setMask((POCR1RA shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR1RA_Fields
...
proc read*(reg: PSC_POCR1SA_Type): PSC_POCR1SA_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR1SA_Fields](reg.loc))

proc write*(reg: PSC_POCR1SA_Type, val: PSC_POCR1SA_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR1SA_Fields](reg.loc), val)

proc write*(reg: PSC_POCR1SA_Type, POCR1SA: uint16 = 0) =
  var x: uint16
  x.setMask((POCR1SA shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR1SA_Fields
...
proc read*(reg: PSC_POCR1SB_Type): PSC_POCR1SB_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR1SB_Fields](reg.loc))

proc write*(reg: PSC_POCR1SB_Type, val: PSC_POCR1SB_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR1SB_Fields](reg.loc), val)

proc write*(reg: PSC_POCR1SB_Type, POCR1SB: uint16 = 0) =
  var x: uint16
  x.setMask((POCR1SB shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR1SB_Fields
...
proc read*(reg: PSC_POCR2RA_Type): PSC_POCR2RA_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR2RA_Fields](reg.loc))

proc write*(reg: PSC_POCR2RA_Type, val: PSC_POCR2RA_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR2RA_Fields](reg.loc), val)

proc write*(reg: PSC_POCR2RA_Type, POCR2RA: uint16 = 0) =
  var x: uint16
  x.setMask((POCR2RA shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR2RA_Fields
...
proc read*(reg: PSC_POCR2SA_Type): PSC_POCR2SA_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR2SA_Fields](reg.loc))

proc write*(reg: PSC_POCR2SA_Type, val: PSC_POCR2SA_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR2SA_Fields](reg.loc), val)

proc write*(reg: PSC_POCR2SA_Type, POCR2SA: uint16 = 0) =
  var x: uint16
  x.setMask((POCR2SA shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR2SA_Fields
...
proc read*(reg: PSC_POCR2SB_Type): PSC_POCR2SB_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR2SB_Fields](reg.loc))

proc write*(reg: PSC_POCR2SB_Type, val: PSC_POCR2SB_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR2SB_Fields](reg.loc), val)

proc write*(reg: PSC_POCR2SB_Type, POCR2SB: uint16 = 0) =
  var x: uint16
  x.setMask((POCR2SB shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR2SB_Fields
...
proc read*(reg: PSC_POCR_RB_Type): PSC_POCR_RB_Fields {.inline.} =
  volatileLoad(cast[ptr PSC_POCR_RB_Fields](reg.loc))

proc write*(reg: PSC_POCR_RB_Type, val: PSC_POCR_RB_Fields) {.inline.} =
  volatileStore(cast[ptr PSC_POCR_RB_Fields](reg.loc), val)

proc write*(reg: PSC_POCR_RB_Type, POCR_RB: uint16 = 0) =
  var x: uint16
  x.setMask((POCR_RB shl 0).masked(0 .. 11))
  reg.write x.PSC_POCR_RB_Fields
...
func POCR0RA*(r: PSC_POCR0RA_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR0RA=`*(r: var PSC_POCR0RA_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR0RA_Fields

func POCR0SA*(r: PSC_POCR0SA_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR0SA=`*(r: var PSC_POCR0SA_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR0SA_Fields

func POCR0SB*(r: PSC_POCR0SB_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR0SB=`*(r: var PSC_POCR0SB_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR0SB_Fields

func POCR1RA*(r: PSC_POCR1RA_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR1RA=`*(r: var PSC_POCR1RA_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR1RA_Fields

func POCR1SA*(r: PSC_POCR1SA_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR1SA=`*(r: var PSC_POCR1SA_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR1SA_Fields

func POCR1SB*(r: PSC_POCR1SB_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR1SB=`*(r: var PSC_POCR1SB_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR1SB_Fields

func POCR2RA*(r: PSC_POCR2RA_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR2RA=`*(r: var PSC_POCR2RA_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR2RA_Fields

func POCR2SA*(r: PSC_POCR2SA_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR2SA=`*(r: var PSC_POCR2SA_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR2SA_Fields

func POCR2SB*(r: PSC_POCR2SB_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR2SB=`*(r: var PSC_POCR2SB_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR2SB_Fields

func POCR_RB*(r: PSC_POCR_RB_Fields): uint16 {.inline.} =
  r.uint16.bitsliced(0 .. 11)

proc `POCR_RB=`*(r: var PSC_POCR_RB_Fields, val: uint16) {.inline.} =
  var tmp = r.uint16
  tmp.clearMask(0 .. 11)
  tmp.setMask((val shl 0).masked(0 .. 11))
  r = tmp.PSC_POCR_RB_Fields
