# Peripheral access API for ATMEGA16A microcontrollers (generated using svd2nim)
...
# #### Device Peripheral Interrupts ############################################
  ...
  irqTIMER0_COMP       =   19 # Timer/Counter0 Compare Match
...
proc write*(reg: CPU_SFIOR_Type, PSR10: bool = false, PSR2: bool = false, PUD: bool = false) =
  var x: uint8
...
proc write*(reg: FUSE_HIGH_Type, BOOTRST: bool = false, BOOTSZ: FUSE_HIGH_BOOTSZ = x1024W_1C00, EESAVE: bool = false, CKOPT: bool = false, SPIEN: bool = false, JTAGEN: bool = false, OCDEN: bool = false) =
  var x: uint8
...
proc write*(reg: USART_UBRRH_Type, UBRR: uint8 = 0, URSEL: bool = false) =
  var x: uint8
