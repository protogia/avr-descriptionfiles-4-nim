# Peripheral access API for ATMEGA328 microcontrollers (generated using svd2nim)
...
proc write*(reg: SPI_SPCR_Type, SPR: SPI_SPCR_SPR = FOSC_2_OR_FOSC_4, CPHA: bool = false, CPOL: bool = false, MSTR: bool = false, DORD: bool = false, SPE: bool = false, SPIE: bool = false) =
  var x: uint8
