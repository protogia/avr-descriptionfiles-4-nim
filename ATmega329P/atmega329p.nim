# Peripheral access API for ATMEGA329P microcontrollers (generated using svd2nim)
...
proc write*(reg: EXINT_PCMSK0_Type, PCINT0: bool = false, PCINT1: bool = false, PCINT2: bool = false, PCINT3: bool = false, PCINT4: bool = false, PCINT5: bool = false, PCINT6: bool = false, PCINT7: bool = false) =
  var x: uint8
  x.setMask((PCINT0.uint8 shl 0).masked(0 .. 0))
  x.setMask((PCINT1.uint8 shl 1).masked(1 .. 1))
  x.setMask((PCINT2.uint8 shl 2).masked(2 .. 2))
  x.setMask((PCINT3.uint8 shl 3).masked(3 .. 3))
  x.setMask((PCINT4.uint8 shl 4).masked(4 .. 4))
  x.setMask((PCINT5.uint8 shl 5).masked(5 .. 5))
  x.setMask((PCINT6.uint8 shl 6).masked(6 .. 6))
  x.setMask((PCINT7.uint8 shl 7).masked(7 .. 7))
...
proc write*(reg: EXINT_PCMSK1_Type, PCINT8: bool = false, PCINT9: bool = false, PCINT10: bool = false, PCINT11: bool = false, PCINT12: bool = false, PCINT13: bool = false, PCINT14: bool = false, PCINT15: bool = false) =
  var x: uint8
  x.setMask((PCINT8.uint8 shl 0).masked(0 .. 0))
  x.setMask((PCINT9.uint8 shl 1).masked(1 .. 1))
  x.setMask((PCINT10.uint8 shl 2).masked(2 .. 2))
  x.setMask((PCINT11.uint8 shl 3).masked(3 .. 3))
  x.setMask((PCINT12.uint8 shl 4).masked(4 .. 4))
  x.setMask((PCINT13.uint8 shl 5).masked(5 .. 5))
  x.setMask((PCINT14.uint8 shl 6).masked(6 .. 6))
  x.setMask((PCINT15.uint8 shl 7).masked(7 .. 7))
...
func PCINT0*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PCINT0=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT1*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PCINT1=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT2*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PCINT2=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT3*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PCINT3=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT4*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PCINT4=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT5*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PCINT5=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT6*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PCINT6=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT7*(r: EXINT_PCMSK0_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PCINT7=`*(r: var EXINT_PCMSK0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.EXINT_PCMSK0_Fields

func PCINT8*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `PCINT8=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT9*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `PCINT9=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT10*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `PCINT10=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT11*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `PCINT11=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT12*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `PCINT12=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT13*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `PCINT13=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT14*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `PCINT14=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.EXINT_PCMSK1_Fields

func PCINT15*(r: EXINT_PCMSK1_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `PCINT15=`*(r: var EXINT_PCMSK1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.EXINT_PCMSK1_Fields
...
type
  ...
  LCD_LCDDR0_Fields* = distinct uint8
  LCD_LCDDR1_Fields* = distinct uint8
  LCD_LCDDR10_Fields* = distinct uint8
  LCD_LCDDR11_Fields* = distinct uint8
  LCD_LCDDR12_Fields* = distinct uint8
  LCD_LCDDR13_Fields* = distinct uint8
  LCD_LCDDR15_Fields* = distinct uint8
  LCD_LCDDR16_Fields* = distinct uint8
  LCD_LCDDR17_Fields* = distinct uint8
  LCD_LCDDR18_Fields* = distinct uint8
  LCD_LCDDR2_Fields* = distinct uint8
  LCD_LCDDR3_Fields* = distinct uint8
  LCD_LCDDR5_Fields* = distinct uint8
  LCD_LCDDR6_Fields* = distinct uint8
  LCD_LCDDR7_Fields* = distinct uint8
  LCD_LCDDR8_Fields* = distinct uint8
...
proc write*(reg: LCD_LCDCRB_Type, LCDPM: LCD_LCDCRB_LCDPM = SEG0_12, LCDMUX: uint8 = 0, LCD2B: bool = false, LCDCS: bool = false) =
  var x: uint8
  x.setMask((LCDPM.uint8 shl 0).masked(0 .. 3))
...
proc read*(reg: LCD_LCDDR0_Type): LCD_LCDDR0_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR0_Fields](reg.loc))

proc write*(reg: LCD_LCDDR0_Type, val: LCD_LCDDR0_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR0_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR0_Type, SEG000: bool = false, SEG001: bool = false, SEG002: bool = false, SEG003: bool = false, SEG004: bool = false, SEG005: bool = false, SEG006: bool = false, SEG007: bool = false) =
  var x: uint8
  x.setMask((SEG000.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG001.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG002.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG003.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG004.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG005.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG006.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG007.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR0_Fields
...
proc read*(reg: LCD_LCDDR1_Type): LCD_LCDDR1_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR1_Fields](reg.loc))

proc write*(reg: LCD_LCDDR1_Type, val: LCD_LCDDR1_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR1_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR1_Type, SEG008: bool = false, SEG009: bool = false, SEG010: bool = false, SEG011: bool = false, SEG012: bool = false, SEG013: bool = false, SEG014: bool = false, SEG015: bool = false) =
  var x: uint8
  x.setMask((SEG008.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG009.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG010.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG011.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG012.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG013.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG014.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG015.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR1_Fields
...
proc read*(reg: LCD_LCDDR10_Type): LCD_LCDDR10_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR10_Fields](reg.loc))

proc write*(reg: LCD_LCDDR10_Type, val: LCD_LCDDR10_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR10_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR10_Type, SEG200: bool = false, SEG201: bool = false, SEG202: bool = false, SEG203: bool = false, SEG204: bool = false, SEG205: bool = false, SEG206: bool = false, SEG207: bool = false) =
  var x: uint8
  x.setMask((SEG200.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG201.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG202.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG203.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG204.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG205.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG206.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG207.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR10_Fields
...
proc read*(reg: LCD_LCDDR11_Type): LCD_LCDDR11_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR11_Fields](reg.loc))

proc write*(reg: LCD_LCDDR11_Type, val: LCD_LCDDR11_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR11_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR11_Type, SEG208: bool = false, SEG209: bool = false, SEG210: bool = false, SEG211: bool = false, SEG212: bool = false, SEG213: bool = false, SEG214: bool = false, SEG215: bool = false) =
  var x: uint8
  x.setMask((SEG208.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG209.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG210.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG211.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG212.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG213.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG214.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG215.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR11_Fields
...
proc read*(reg: LCD_LCDDR12_Type): LCD_LCDDR12_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR12_Fields](reg.loc))

proc write*(reg: LCD_LCDDR12_Type, val: LCD_LCDDR12_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR12_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR12_Type, SEG216: bool = false, SEG217: bool = false, SEG218: bool = false, SEG219: bool = false, SEG220: bool = false, SEG221: bool = false, SEG222: bool = false, SEG223: bool = false) =
  var x: uint8
  x.setMask((SEG216.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG217.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG218.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG219.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG220.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG221.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG222.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG223.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR12_Fields
...
proc read*(reg: LCD_LCDDR13_Type): LCD_LCDDR13_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR13_Fields](reg.loc))

proc write*(reg: LCD_LCDDR13_Type, val: LCD_LCDDR13_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR13_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR13_Type, SEG224: bool = false, SEG225: bool = false, SEG226: bool = false, SEG227: bool = false, SEG228: bool = false, SEG229: bool = false, SEG230: bool = false, SEG231: bool = false) =
  var x: uint8
  x.setMask((SEG224.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG225.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG226.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG227.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG228.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG229.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG230.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG231.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR13_Fields
...
proc read*(reg: LCD_LCDDR15_Type): LCD_LCDDR15_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR15_Fields](reg.loc))

proc write*(reg: LCD_LCDDR15_Type, val: LCD_LCDDR15_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR15_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR15_Type, SEG300: bool = false, SEG301: bool = false, SEG302: bool = false, SEG303: bool = false, SEG304: bool = false, SEG305: bool = false, SEG306: bool = false, SEG307: bool = false) =
  var x: uint8
  x.setMask((SEG300.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG301.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG302.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG303.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG304.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG305.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG306.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG307.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR15_Fields
...
proc read*(reg: LCD_LCDDR16_Type): LCD_LCDDR16_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR16_Fields](reg.loc))

proc write*(reg: LCD_LCDDR16_Type, val: LCD_LCDDR16_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR16_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR16_Type, SEG308: bool = false, SEG309: bool = false, SEG310: bool = false, SEG311: bool = false, SEG312: bool = false, SEG313: bool = false, SEG314: bool = false, SEG315: bool = false) =
  var x: uint8
  x.setMask((SEG308.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG309.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG310.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG311.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG312.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG313.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG314.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG315.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR16_Fields
...
proc read*(reg: LCD_LCDDR17_Type): LCD_LCDDR17_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR17_Fields](reg.loc))

proc write*(reg: LCD_LCDDR17_Type, val: LCD_LCDDR17_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR17_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR17_Type, SEG316: bool = false, SEG317: bool = false, SEG318: bool = false, SEG319: bool = false, SEG320: bool = false, SEG321: bool = false, SEG322: bool = false, SEG323: bool = false) =
  var x: uint8
  x.setMask((SEG316.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG317.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG318.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG319.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG320.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG321.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG322.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG323.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR17_Fields
...
proc read*(reg: LCD_LCDDR18_Type): LCD_LCDDR18_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR18_Fields](reg.loc))

proc write*(reg: LCD_LCDDR18_Type, val: LCD_LCDDR18_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR18_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR18_Type, SEG324: bool = false, SEG325: bool = false, SEG326: bool = false, SEG327: bool = false, SEG328: bool = false, SEG329: bool = false, SEG330: bool = false, SEG331: bool = false) =
  var x: uint8
  x.setMask((SEG324.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG325.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG326.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG327.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG328.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG329.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG330.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG331.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR18_Fields
...
proc read*(reg: LCD_LCDDR2_Type): LCD_LCDDR2_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR2_Fields](reg.loc))

proc write*(reg: LCD_LCDDR2_Type, val: LCD_LCDDR2_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR2_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR2_Type, SEG016: bool = false, SEG017: bool = false, SEG018: bool = false, SEG019: bool = false, SEG020: bool = false, SEG021: bool = false, SEG022: bool = false, SEG023: bool = false) =
  var x: uint8
  x.setMask((SEG016.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG017.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG018.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG019.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG020.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG021.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG022.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG023.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR2_Fields
...
proc read*(reg: LCD_LCDDR3_Type): LCD_LCDDR3_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR3_Fields](reg.loc))

proc write*(reg: LCD_LCDDR3_Type, val: LCD_LCDDR3_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR3_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR3_Type, SEG024: bool = false, SEG025: bool = false, SEG026: bool = false, SEG027: bool = false, SEG028: bool = false, SEG029: bool = false, SEG030: bool = false, SEG031: bool = false) =
  var x: uint8
  x.setMask((SEG024.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG025.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG026.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG027.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG028.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG029.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG030.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG031.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR3_Fields
...
proc read*(reg: LCD_LCDDR5_Type): LCD_LCDDR5_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR5_Fields](reg.loc))

proc write*(reg: LCD_LCDDR5_Type, val: LCD_LCDDR5_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR5_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR5_Type, SEG100: bool = false, SEG101: bool = false, SEG102: bool = false, SEG103: bool = false, SEG104: bool = false, SEG105: bool = false, SEG106: bool = false, SEG107: bool = false) =
  var x: uint8
  x.setMask((SEG100.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG101.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG102.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG103.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG104.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG105.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG106.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG107.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR5_Fields
...
proc read*(reg: LCD_LCDDR6_Type): LCD_LCDDR6_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR6_Fields](reg.loc))

proc write*(reg: LCD_LCDDR6_Type, val: LCD_LCDDR6_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR6_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR6_Type, SEG108: bool = false, SEG109: bool = false, SEG110: bool = false, SEG111: bool = false, SEG112: bool = false, SEG113: bool = false, SEG114: bool = false, SEG115: bool = false) =
  var x: uint8
  x.setMask((SEG108.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG109.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG110.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG111.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG112.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG113.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG114.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG115.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR6_Fields
...
proc read*(reg: LCD_LCDDR7_Type): LCD_LCDDR7_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR7_Fields](reg.loc))

proc write*(reg: LCD_LCDDR7_Type, val: LCD_LCDDR7_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR7_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR7_Type, SEG116: bool = false, SEG117: bool = false, SEG118: bool = false, SEG119: bool = false, SEG120: bool = false, SEG121: bool = false, SEG122: bool = false, SEG123: bool = false) =
  var x: uint8
  x.setMask((SEG116.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG117.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG118.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG119.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG120.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG121.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG122.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG123.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR7_Fields
...
proc read*(reg: LCD_LCDDR8_Type): LCD_LCDDR8_Fields {.inline.} =
  volatileLoad(cast[ptr LCD_LCDDR8_Fields](reg.loc))

proc write*(reg: LCD_LCDDR8_Type, val: LCD_LCDDR8_Fields) {.inline.} =
  volatileStore(cast[ptr LCD_LCDDR8_Fields](reg.loc), val)

proc write*(reg: LCD_LCDDR8_Type, SEG124: bool = false, SEG125: bool = false, SEG126: bool = false, SEG127: bool = false, SEG128: bool = false, SEG129: bool = false, SEG130: bool = false, SEG131: bool = false) =
  var x: uint8
  x.setMask((SEG124.uint8 shl 0).masked(0 .. 0))
  x.setMask((SEG125.uint8 shl 1).masked(1 .. 1))
  x.setMask((SEG126.uint8 shl 2).masked(2 .. 2))
  x.setMask((SEG127.uint8 shl 3).masked(3 .. 3))
  x.setMask((SEG128.uint8 shl 4).masked(4 .. 4))
  x.setMask((SEG129.uint8 shl 5).masked(5 .. 5))
  x.setMask((SEG130.uint8 shl 6).masked(6 .. 6))
  x.setMask((SEG131.uint8 shl 7).masked(7 .. 7))
  reg.write x.LCD_LCDDR8_Fields
...
func LCDPM*(r: LCD_LCDCRB_Fields): UncheckedEnum[LCD_LCDCRB_LCDPM] {.inline.} =
  toUncheckedEnum[LCD_LCDCRB_LCDPM](r.uint8.bitsliced(0 .. 3).int)
...
func SEG000*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG000=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR0_Fields

func SEG001*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG001=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR0_Fields

func SEG002*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG002=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR0_Fields

func SEG003*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG003=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR0_Fields

func SEG004*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG004=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR0_Fields

func SEG005*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG005=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR0_Fields

func SEG006*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG006=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR0_Fields

func SEG007*(r: LCD_LCDDR0_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG007=`*(r: var LCD_LCDDR0_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR0_Fields

func SEG008*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG008=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR1_Fields

func SEG009*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG009=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR1_Fields

func SEG010*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG010=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR1_Fields

func SEG011*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG011=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR1_Fields

func SEG012*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG012=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR1_Fields

func SEG013*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG013=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR1_Fields

func SEG014*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG014=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR1_Fields

func SEG015*(r: LCD_LCDDR1_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG015=`*(r: var LCD_LCDDR1_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR1_Fields

func SEG200*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG200=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR10_Fields

func SEG201*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG201=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR10_Fields

func SEG202*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG202=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR10_Fields

func SEG203*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG203=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR10_Fields

func SEG204*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG204=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR10_Fields

func SEG205*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG205=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR10_Fields

func SEG206*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG206=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR10_Fields

func SEG207*(r: LCD_LCDDR10_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG207=`*(r: var LCD_LCDDR10_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR10_Fields

func SEG208*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG208=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR11_Fields

func SEG209*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG209=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR11_Fields

func SEG210*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG210=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR11_Fields

func SEG211*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG211=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR11_Fields

func SEG212*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG212=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR11_Fields

func SEG213*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG213=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR11_Fields

func SEG214*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG214=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR11_Fields

func SEG215*(r: LCD_LCDDR11_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG215=`*(r: var LCD_LCDDR11_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR11_Fields

func SEG216*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG216=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR12_Fields

func SEG217*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG217=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR12_Fields

func SEG218*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG218=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR12_Fields

func SEG219*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG219=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR12_Fields

func SEG220*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG220=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR12_Fields

func SEG221*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG221=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR12_Fields

func SEG222*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG222=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR12_Fields

func SEG223*(r: LCD_LCDDR12_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG223=`*(r: var LCD_LCDDR12_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR12_Fields

func SEG224*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG224=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR13_Fields

func SEG225*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG225=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR13_Fields

func SEG226*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG226=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR13_Fields

func SEG227*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG227=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR13_Fields

func SEG228*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG228=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR13_Fields

func SEG229*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG229=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR13_Fields

func SEG230*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG230=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR13_Fields

func SEG231*(r: LCD_LCDDR13_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG231=`*(r: var LCD_LCDDR13_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR13_Fields

func SEG300*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG300=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR15_Fields

func SEG301*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG301=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR15_Fields

func SEG302*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG302=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR15_Fields

func SEG303*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG303=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR15_Fields

func SEG304*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG304=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR15_Fields

func SEG305*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG305=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR15_Fields

func SEG306*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG306=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR15_Fields

func SEG307*(r: LCD_LCDDR15_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG307=`*(r: var LCD_LCDDR15_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR15_Fields

func SEG308*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG308=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR16_Fields

func SEG309*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG309=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR16_Fields

func SEG310*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG310=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR16_Fields

func SEG311*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG311=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR16_Fields

func SEG312*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG312=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR16_Fields

func SEG313*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG313=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR16_Fields

func SEG314*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG314=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR16_Fields

func SEG315*(r: LCD_LCDDR16_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG315=`*(r: var LCD_LCDDR16_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR16_Fields

func SEG316*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG316=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR17_Fields

func SEG317*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG317=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR17_Fields

func SEG318*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG318=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR17_Fields

func SEG319*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG319=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR17_Fields

func SEG320*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG320=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR17_Fields

func SEG321*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG321=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR17_Fields

func SEG322*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG322=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR17_Fields

func SEG323*(r: LCD_LCDDR17_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG323=`*(r: var LCD_LCDDR17_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR17_Fields

func SEG324*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG324=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR18_Fields

func SEG325*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG325=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR18_Fields

func SEG326*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG326=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR18_Fields

func SEG327*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG327=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR18_Fields

func SEG328*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG328=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR18_Fields

func SEG329*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG329=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR18_Fields

func SEG330*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG330=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR18_Fields

func SEG331*(r: LCD_LCDDR18_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG331=`*(r: var LCD_LCDDR18_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR18_Fields

func SEG016*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG016=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR2_Fields

func SEG017*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG017=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR2_Fields

func SEG018*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG018=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR2_Fields

func SEG019*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG019=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR2_Fields

func SEG020*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG020=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR2_Fields

func SEG021*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG021=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR2_Fields

func SEG022*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG022=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR2_Fields

func SEG023*(r: LCD_LCDDR2_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG023=`*(r: var LCD_LCDDR2_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR2_Fields

func SEG024*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG024=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR3_Fields

func SEG025*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG025=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR3_Fields

func SEG026*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG026=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR3_Fields

func SEG027*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG027=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR3_Fields

func SEG028*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG028=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR3_Fields

func SEG029*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG029=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR3_Fields

func SEG030*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG030=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR3_Fields

func SEG031*(r: LCD_LCDDR3_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG031=`*(r: var LCD_LCDDR3_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR3_Fields

func SEG100*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG100=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR5_Fields

func SEG101*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG101=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR5_Fields

func SEG102*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG102=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR5_Fields

func SEG103*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG103=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR5_Fields

func SEG104*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG104=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR5_Fields

func SEG105*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG105=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR5_Fields

func SEG106*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG106=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR5_Fields

func SEG107*(r: LCD_LCDDR5_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG107=`*(r: var LCD_LCDDR5_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR5_Fields

func SEG108*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG108=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR6_Fields

func SEG109*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG109=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR6_Fields

func SEG110*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG110=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR6_Fields

func SEG111*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG111=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR6_Fields

func SEG112*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG112=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR6_Fields

func SEG113*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG113=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR6_Fields

func SEG114*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG114=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR6_Fields

func SEG115*(r: LCD_LCDDR6_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG115=`*(r: var LCD_LCDDR6_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR6_Fields

func SEG116*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG116=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR7_Fields

func SEG117*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG117=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR7_Fields

func SEG118*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG118=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR7_Fields

func SEG119*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG119=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR7_Fields

func SEG120*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG120=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR7_Fields

func SEG121*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG121=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR7_Fields

func SEG122*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG122=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR7_Fields

func SEG123*(r: LCD_LCDDR7_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG123=`*(r: var LCD_LCDDR7_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR7_Fields

func SEG124*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(0 .. 0).bool

proc `SEG124=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(0 .. 0)
  tmp.setMask((val.uint8 shl 0).masked(0 .. 0))
  r = tmp.LCD_LCDDR8_Fields

func SEG125*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(1 .. 1).bool

proc `SEG125=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(1 .. 1)
  tmp.setMask((val.uint8 shl 1).masked(1 .. 1))
  r = tmp.LCD_LCDDR8_Fields

func SEG126*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(2 .. 2).bool

proc `SEG126=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(2 .. 2)
  tmp.setMask((val.uint8 shl 2).masked(2 .. 2))
  r = tmp.LCD_LCDDR8_Fields

func SEG127*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(3 .. 3).bool

proc `SEG127=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(3 .. 3)
  tmp.setMask((val.uint8 shl 3).masked(3 .. 3))
  r = tmp.LCD_LCDDR8_Fields

func SEG128*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(4 .. 4).bool

proc `SEG128=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(4 .. 4)
  tmp.setMask((val.uint8 shl 4).masked(4 .. 4))
  r = tmp.LCD_LCDDR8_Fields

func SEG129*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(5 .. 5).bool

proc `SEG129=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(5 .. 5)
  tmp.setMask((val.uint8 shl 5).masked(5 .. 5))
  r = tmp.LCD_LCDDR8_Fields

func SEG130*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(6 .. 6).bool

proc `SEG130=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(6 .. 6)
  tmp.setMask((val.uint8 shl 6).masked(6 .. 6))
  r = tmp.LCD_LCDDR8_Fields

func SEG131*(r: LCD_LCDDR8_Fields): bool {.inline.} =
  r.uint8.bitsliced(7 .. 7).bool

proc `SEG131=`*(r: var LCD_LCDDR8_Fields, val: bool) {.inline.} =
  var tmp = r.uint8
  tmp.clearMask(7 .. 7)
  tmp.setMask((val.uint8 shl 7).masked(7 .. 7))
  r = tmp.LCD_LCDDR8_Fields
