# Peripheral access API for ATMEGA8A microcontrollers (generated using svd2nim)
...
proc write*(reg: ADC_ADCSRA_Type, ADPS: ADC_ADCSRA_ADPS = x2, ADIE: bool = false, ADIF: bool = false, ADFR: bool = false, ADSC: bool = false, ADEN: bool = false) =
  var x: uint8
...
proc write*(reg: TC0_TCCR0_Type, CS00: TC0_TCCR0_CS00 = NO_CLOCK_SOURCE_STOPPED, CS01: bool = false, CS02: bool = false) =
  var x: uint8
